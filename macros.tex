...
\newcommand{\ttrans}[2]{\inparens{#1 \Rightarrow #2}}
...
\newcommand{\htypjudge}[3]{#1 \vdash #2 : #3}
\newcommand{\htrans}[4]{#1 \vdash #2 : \ttrans{#3}{#4}}
\newcommand{\dashV}{\mathbin{\rotatebox[origin=c]{180}{$\Vdash$}}}
\newcommand{\hpatmatch}[3]{#1 : #2 \dashV #3}

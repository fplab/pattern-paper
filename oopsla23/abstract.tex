\begin{abstract}
    ...
    We scale up the core calculus to support finite labeled sums, adding support for \emph{datatype constructor holes} in the process.\todo{is this sentence still needed?}
    Finally, we implement these mechanisms within Hazel, a  

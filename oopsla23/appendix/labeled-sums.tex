...
\input{fig-labeled-sums-pattern-matching-rules} Moving on to the
dynamic semantics,
\Autoref{fig:labeled-sums-pattern-matching-rules,fig:labeled-sums-evaluation-rules}
...
by \Autoref{lem:val-not-indet,lem:val-not-notintro,lem:finality}.
...
by generalizing the rules for binary injections from \rulesref{rules:TExp}, \ref{rules:PatTyp}, \ref{rules:CTRule}, and \ref{rules:CTRules}.

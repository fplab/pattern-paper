...
There has also been recent progress in bringing graduality to dependent type as an attempt to reason about unknown terms/types
...
\todo{want to make sure this is accurate}
Their goal is to make dependent type system more usable in general, while we want to enable reasoning at \textit{all} program editing states with a focus on patterns.

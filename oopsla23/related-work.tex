...
We did not formalize the external language, which is bidirectionally typed, because a simply typed lambda calculus like Peanut can be turned into a bidirectional one in a semi-systematic and thus straightforward way \cite{DBLP:journals/csur/DunfieldK21}. Our implementation includes a bidirectionally typed external language, whose elaboration to Peanut, the internal language, follows \citet{DBLP:journals/pacmpl/OmarVCH19} closely.

...
\begin{lemma}
\label{lem:notintro-refutable}
If $\notIntro{e}$ and $\refutable{\xi}$ then either $\refutable{\ctruify{\xi}}$ or $\csatisfy{e}{\ctruify{\xi}}$.
\end{lemma}
\begin{proof}
...
If $\notIntro{e}$ and $\csatisfy{e}{\xi}$ then $\cancel{\refutable{\xi}}$.
\end{lemma}
\begin{proof}
\begin{pfsteps*}
...
\item[\text{(\ref{rule:CSNotIntroPair})}]
    ...
    \item $\cancel{\refutable{\xi_1}}$ \BY{IH on \pfref{prl-notintro} and \pfref{prl-satisfy}} \pflabel{not-rft1}
    \item $\cancel{\refutable{\xi_2}}$ \BY{IH on \pfref{prr-notintro} and \pfref{prr-satisfy}} \pflabel{not-rft2}
    \end{pfsteps*}
  ...
  \begin{enumerate}
    \item Soundness:
      ...
      \item[\text{(\ref{rule:CSNotIntroPair})}]
        ...
        \item $\csatisfy{\hprl{e}}{\xi_1}$ \BY{assumption} \pflabel{[notintro]csatisfy1}
        \item $\csatisfy{\hprr{e}}{\xi_2}$ \BY{assumption} \pflabel{[notintro]csatisfy2}
        \item $\fsatisfy{\hprl{e}}{\xi_1} = \true$ \BY{IH on \pfref{[notintro]csatisfy1}} \pflabel{[notintro]fsatisfy1}
        \item $\fsatisfy{\hprr{e}}{\xi_2} = \true$ \BY{IH on \pfref{[notintro]csatisfy2}} \pflabel{[notintro]fsatisfy2}
        \end{pfsteps*}
        ...
        \item
          ...
          \item $\fsatisfy{e}{\cpair{\xi_1}{\xi_2}} = \fsatisfy{\hprl{e}}{\xi_1} \text{ and } \fsatisfy{\hprr{e}}{\xi_2} = \true$ \BY{Definition \ref{defn:satisfy} on \pfref{[notintro]fsatisfy1} and \pfref{[notintro]fsatisfy2}}
          \end{pfsteps*}
        \end{byCases}
      \end{byCases}
      ...
      \item[\xi=\cpair{\xi_1}{\xi_2}]\ \\
        ...
        \begin{byCases}
          ...
          \item[e=\hehole{u},\hhole{e_0}{u},\hap{e_1}{e_2},\hprl{e_0},\hprr{e_0},\hmatch{e_0}{\zrules}]
            \begin{pfsteps*}
            \item $\fsatisfy{\hprl{e}}{\xi_1} = \true$ \BY{Definition \ref{defn:pair-satisfy-pair} on \pfref{fsatisfy}} \pflabel{[notintro]fsatisfy1}
            \item $\fsatisfy{\hprr{e}}{\xi_2} = \true$ \BY{Definition \ref{defn:pair-satisfy-pair} on \pfref{fsatisfy}} \pflabel{[notintro]fsatisfy2}
            \item $\csatisfy{\hprl{e}}{\xi_1}$ \BY{IH on \pfref{[notintro]fsatisfy1}} \pflabel{[notintro]csatisfy1}
            \item $\csatisfy{\hprr{e}}{\xi_2}$ \BY{IH on \pfref{[notintro]fsatisfy2}} \pflabel{[notintro]csatisfy2}
            \item $\notIntro{e}$ \BY{each rule in \rulesref{rules:notintro}} \pflabel{[notintro]notintro}
            \item $\csatisfy{\hpair{e_1}{e_2}}{\cpair{\xi_1}{\xi_2}}$ \BY{Rule (\ref{rule:CSNotIntroPair}) on \pfref{[notintro]notintro} and \pfref{[notintro]csatisfy1} and \pfref{[notintro]csatisfy2}}
            \end{pfsteps*}
          \restorelocalsteps{lem:sound-complete-satisfy-2}
          \item
            \begin{pfsteps*}
...
\item[\text{(\ref{rule:CTNotNum})}]
    ...
    \item[\text{(\ref{rule:TEHole}),(\ref{rule:THole}),(\ref{rule:TAp}),(\ref{rule:TPrl}),(\ref{rule:TPrr}),(\ref{rule:TMatchZPre}),(\ref{rule:TMatchNZPre})}]
        \begin{pfsteps*}
        \item $e=\hehole{u},\hhole{e_0}{u},\hap{e_1}{e_2},\hprl{e_0},\hprr{e_0},\hmatch{e_0}{\zrules}$ \BY{assumption}
         \item $\notIntro{e}$ \BY{Rule (\ref{rule:NVEHole}),(\ref{rule:NVHole}),(\ref{rule:NVAp}),(\ref{rule:NVMatch}),(\ref{rule:NVPrl}),(\ref{rule:NVPrr})} \pflabel{[notnum]notintro}
        \end{pfsteps*}
        ...
        \item $\cmaysatisfy{e}{\cnum{n_2}}$ \BY{Rule (\ref{rule:CMSNotIntro}) on \pfref{[notnum]notintro} and \pfref{[notnum]rft}} \pflabel{[notnum]maysat}
...
\item[\text{(\ref{rule:CTInl})}]
    ...
    \item[\text{(\ref{rule:TEHole}),(\ref{rule:THole}),(\ref{rule:TAp}),(\ref{rule:TPrl}),(\ref{rule:TPrr}),(\ref{rule:TMatchZPre}),(\ref{rule:TMatchNZPre})}]
        ...
        \item[\frefutable{\cinl{\xi_1}}=\true]
            ...
            \item $\cmaysatisfy{e}{\cinl{\xi_1}}$ \BY{\ruleref{rule:CMSNotIntro} on \pfref{[inl]notintro} and \pfref{[inl]rft-true}} \pflabel{[inl]maysat}
...
\item[\text{(\ref{rule:CTInr})}]
    ...
    \item[\text{(\ref{rule:TEHole}),(\ref{rule:THole}),(\ref{rule:TAp}),(\ref{rule:TPrl}),(\ref{rule:TPrr}),(\ref{rule:TMatchZPre}),(\ref{rule:TMatchNZPre})}]
        ...
        \end{pfsteps*}
        By case analysis on the value of $\frefutable{\cinr{\xi_2}}$. \todo{inr is refutable}
        \begin{byCases}
        \savelocalsteps{2}
        \item[\frefutable{\cinr{\xi_2}}=\true]
            ...
            \item $\cmaysatisfy{e}{\cinr{\xi_2}}$ \BY{\ruleref{rule:CMSNotIntro} on \pfref{[inr]notintro} and \pfref{[inr]rft-true}} \pflabel{[inr]maysat}
...
\begin{pfsteps*}
    ...
    \item[\text{(\ref{rule:TEHole}),(\ref{rule:THole}),(\ref{rule:TAp}),(\ref{rule:TPrl}),(\ref{rule:TPrr}),(\ref{rule:TMatchZPre}),(\ref{rule:TMatchNZPre})}]
        ...
        \item[\csatisfy{\hprl{e}}{\xi_1},\csatisfy{\hprr{e}}{\xi_2}]
            ...
            \item $\csatisfy{e}{\cpair{\xi_1}{\xi_2}}$ \BY{Rule (\ref{rule:CSNotIntroPair}) on \pfref{[pair]notintro} and \pfref{[pair1]satisfy1} and \pfref{[pair1]satisfy2}} \pflabel{[pair1]satisfy-pair}
            \item $\csatisfyormay{e}{\cpair{\xi_1}{\xi_2}}$ \BY{\ruleref{rule:CSMSSat} on \pfref{[pair1]satisfy-pair}}
            \item $\cancel{\refutable{\cpair{\xi_1}{\xi_2}}}$ \BY{\autoref{lem:satisfy-not-refutable} on \pfref{[pair]notintro} and \pfref{[pair1]satisfy-pair}} \pflabel{[pair1]not-rft-pair}
            \end{pfsteps*}
        ...
        \item[\csatisfy{\hprl{e}}{\xi_1},\cmaysatisfy{\hprr{e}}{\xi_2}]
            ...
            \item[\text{(\ref{rule:CMSNotIntro})}]
                ...
                \item $\cmaysatisfy{e}{\cpair{\xi_1}{\xi_2}}$ \BY{\ruleref{rule:CMSNotIntro} on \pfref{[pair]notintro} and \pfref{[pair2]rft-pair}} \pflabel{[pair2]maysat-pair}
        ...
        \item[\csatisfy{\hprl{e}}{\xi_1},\cnotsatisfyormay{\hprr{e}}{\xi_2}]
            ...
            \item[\text{(\ref{rule:CMSNotIntro})}]
                ...
                \item[\text{(\ref{rule:RXPairL})}]
                    ...
                    \item $\cmaysatisfy{\hprl{e}}{\xi_1}$ \BY{\ruleref{rule:CMSNotIntro} on \pfref{[pair3]prl-notintro} and \pfref{[pair3]rft1}}
                    \end{pfsteps*}
                ...
                \item[\text{(\ref{rule:RXPairR})}]
                    ...
                    \item $\cmaysatisfy{\hprr{e}}{\xi_2}$ \BY{\ruleref{rule:CMSNotIntro} on \pfref{[pair3]prr-notintro} and \pfref{[pair3]rft2}}
                    \end{pfsteps*}
        ...
        \item[\cmaysatisfy{\hprl{e}}{\xi_1},\csatisfy{\hprr{e}}{\xi_2}]
            ...
            \item[\text{(\ref{rule:CMSNotIntro})}]
                ...
                \item $\cmaysatisfy{e}{\cpair{\xi_1}{\xi_2}}$ \BY{\ruleref{rule:CMSNotIntro} on \pfref{[pair]notintro} and \pfref{[pair4]rft-pair}} \pflabel{[pair4]maysat-pair}
        ...
        \item[\cmaysatisfy{\hprl{e}}{\xi_1},\cmaysatisfy{\hprr{e}}{\xi_2}]
            ...
            \item[\text{(\ref{rule:CMSNotIntro})}]
                ...
                \item $\cmaysatisfy{e}{\cpair{\xi_1}{\xi_2}}$ \BY{\ruleref{rule:CMSNotIntro} on \pfref{[pair]notintro} and \pfref{[pair5]rft-pair}} \pflabel{[pair5]maysat-pair}
        ...
        \item[\cmaysatisfy{\hprl{e}}{\xi_1},\cnotsatisfyormay{\hprr{e}}{\xi_2}]
            ...
            \item[\text{(\ref{rule:CMSNotIntro})}]
                ...
                \item $\cmaysatisfy{e}{\cpair{\xi_1}{\xi_2}}$ \BY{\ruleref{rule:CMSNotIntro} on \pfref{[pair]notintro} and \pfref{[pair6]rft-pair}} \pflabel{[pair6]maysat-pair}
        ...
        \item[\cnotsatisfyormay{\hprl{e}}{\xi_1},\csatisfy{\hprr{e}}{\xi_2}]
            ...
            \item[\text{(\ref{rule:CMSNotIntro})}]
                ...
                \item[\text{(\ref{rule:RXPairL})}]
                    ...
                    \item $\cmaysatisfy{\hprl{e}}{\xi_1}$ \BY{\ruleref{rule:CMSNotIntro} on \pfref{[pair7]prl-notintro} and \pfref{[pair7]rft1}}
                    \end{pfsteps*}
                    Contradicts \pfref{[pair3]notmaysat1}.
                \restorelocalsteps{2}
                \item[\text{(\ref{rule:RXPairR})}]
                    ...
                    \item $\cmaysatisfy{\hprr{e}}{\xi_2}$ \BY{\ruleref{rule:CMSNotIntro} on \pfref{[pair7]prr-notintro} and \pfref{[pair7]rft2}}
                    \end{pfsteps*}
        ...
        \item[\cnotsatisfyormay{\hprl{e}}{\xi_1},\cmaysatisfy{\hprr{e}}{\xi_2}]
            ...
            \item[\text{(\ref{rule:CMSNotIntro})}]
                ...
                \item $\cmaysatisfy{e}{\cpair{\xi_1}{\xi_2}}$ \BY{\ruleref{rule:CMSNotIntro} on \pfref{[pair]notintro} and \pfref{[pair8]rft-pair}} \pflabel{[pair8]maysat-pair}
        ...
        \item[\cnotsatisfyormay{\hprl{e}}{\xi_1},\cnotsatisfyormay{\hprr{e}}{\xi_2}]
            ...
            \item[\text{(\ref{rule:CMSNotIntro})}]
                ...
                \item[\text{(\ref{rule:RXPairL})}]
                    ...
                    \item $\cmaysatisfy{\hprl{e}}{\xi_1}$ \BY{\ruleref{rule:CMSNotIntro} on \pfref{[pair9]prl-notintro} and \pfref{[pair9]rft1}}
                    \end{pfsteps*}
                ...
                \item[\text{(\ref{rule:RXPairR})}]
                    ...
                    \item $\cmaysatisfy{\hprr{e}}{\xi_2}$ \BY{\ruleref{rule:CMSNotIntro} on \pfref{[pair9]prr-notintro} and \pfref{[pair9]rft2}}
                    \end{pfsteps*}

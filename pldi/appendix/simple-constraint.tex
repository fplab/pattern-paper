...
\begin{subequations}\label{defn:maysatisfy}
  \begin{align}
    ...
    \fmaysatisfy{e}{\hxi} =& \fnotIntro{e} \textand \frefutable{\hxi} \label{defn:notintor-maysat-refutable}\\
    \text{Otherwise}\quad \fmaysatisfy{e}{\hxi} ={}& \false \label{defn:not-maysat}
  \end{align}
\end{subequations}
...
\begin{proof}
  ...
  \begin{enumerate}
    ...
    \begin{byCases}
      ...
      \item $\fmaysatisfy{e}{\cunknown}$ \BY{\autoref{defn:maysat-unknown}}
      \end{pfsteps*} 
      \restorelocalsteps{0}
      ...
      \item $\fmaysatisfy{e_1}{\hxi_1}$ \BY{IH on \pfref{[inl]maysat1}} \pflabel{[inl]fmaysat1}
      \item $\fmaysatisfy{\hinl{\tau_2}{e_1}}{\cinl{\hxi_1}}$ \BY{\autoref{defn:maysat-inl} on \pfref{[inl]fmaysat1}}
      \end{pfsteps*}
      \restorelocalsteps{0}
      ...
      \item $\fmaysatisfy{e_2}{\hxi_2}$ \BY{IH on \pfref{[inr]maysat2}} \pflabel{[inr]fmaysat2}
      \item $\fmaysatisfy{\hinr{\tau_1}{e_2}}{\cinr{\hxi_2}}$ \BY{\autoref{defn:maysat-inr} on \pfref{[inr]fmaysat2}}
      \end{pfsteps*}
      \restorelocalsteps{0}
      ...
      \item $\fmaysatisfy{e_1}{\hxi_1}$ \BY{IH on \pfref{[pair1]maysat1}} \pflabel{[pair1]fmaysat1}
      \item $\fsatisfy{e_2}{\hxi_2}$ \BY{\autoref{lem:sound-complete-satisfy} on \pfref{[pair1]satisfy2}} \pflabel{[pair1]fsatisfy2}
      \item $\fmaysatisfy{\hpair{\hxi_1}{\hxi_2}}{\cpair{\hxi_1}{\hxi_2}}$ \BY{\autoref{defn:maysat-pair} on \pfref{[pair1]fmaysat1} and \pfref{[pair1]fsatisfy2}}
      \end{pfsteps*}
      \restorelocalsteps{0}
      ...
      \item $\fsatisfy{e_1}{\hxi_1}$ \BY{\autoref{lem:sound-complete-satisfy} on \pfref{[pair2]satisfy1}} \pflabel{[pair2]fsatisfy1}
      \item $\fmaysatisfy{e_2}{\hxi_2}$ \BY{IH on \pfref{[pair2]maysat2}} \pflabel{[pair2]fmaysat2}
      \item $\fmaysatisfy{\hpair{\hxi_1}{\hxi_2}}{\cpair{\hxi_1}{\hxi_2}}$ \BY{\autoref{defn:maysat-pair} on \pfref{[pair2]fsatisfy1} and \pfref{[pair2]fmaysat2}}
      \end{pfsteps*}
      \restorelocalsteps{0}
      ...
      \item $\fmaysatisfy{e_1}{\hxi_1}$ \BY{IH on \pfref{[pair3]maysat1}} \pflabel{[pair3]fmaysat1}
      \item $\fmaysatisfy{e_2}{\hxi_2}$ \BY{IH on \pfref{[pair3]maysat2}} \pflabel{[pair3]fmaysat2}
      \item $\fmaysatisfy{\hpair{\hxi_1}{\hxi_2}}{\cpair{\hxi_1}{\hxi_2}}$ \BY{\autoref{defn:maysat-pair} on \pfref{[pair3]fmaysat1} and \pfref{[pair3]fmaysat2}}
      \end{pfsteps*}
      \restorelocalsteps{0}
      ...
      \item $\fmaysatisfy{e}{\hxi_1}$ \BY{IH on \pfref{[or1]maysat1}} \pflabel{[or1]fmaysat1}
      \item $\textnot \fsatisfy{e}{\hxi_2}$ \BY{\autoref{lem:sound-complete-satisfy} on \pfref{[or1]notsat2}} \pflabel{[or1]fnotsat2}
      \item $\fmaysatisfy{e}{\cor{\hxi_1}{\hxi_2}}$ \BY{\autoref{defn:satisfy-or} on \pfref{[or1]fmaysat1} and \pfref{[or1]fnotsat2}}
      \end{pfsteps*} 
      \restorelocalsteps{0}
      ...
      \item $\textnot \fsatisfy{e}{\hxi_1}$ \BY{\autoref{lem:sound-complete-satisfy} on \pfref{[or2]notsat1}} \pflabel{[or2]fnotsat1}
      \item $\fmaysatisfy{e}{\hxi_2}$ \BY{IH on \pfref{[or2]maysat2}} \pflabel{[or2]fmaysat2}
      \item $\fmaysatisfy{e}{\cor{\hxi_1}{\hxi_2}}$ \BY{\autoref{defn:satisfy-or} on \pfref{[or2]fnotsat1} and \pfref{[or2]fmaysat2}}
      \end{pfsteps*} 
      \restorelocalsteps{0}
      \item[\text{(\ref{rule:CMSNotIntro})}]
      \begin{pfsteps*}
      \item $\notIntro{e}$ \BY{assumption} \pflabel{notinro}
      \item $\refutable{\hxi}$ \BY{assumption} \pflabel{refutable}
      \item $\fnotIntro{e}$ \BY{\autoref{lem:sound-complete-notintro} on \pfref{notintro}} \pflabel{fnotintro}
      \item $\frefutable{\hxi}$ \BY{\autoref{lem:sound-complete-xi-refutable} on \pfref{refutable}} \pflabel{frefutable}
      \item $\fmaysatisfy{e}{\hxi}$ \BY{\autoref{defn:notintor-maysat-refutable} on \pfref{fnotintro} and \pfref{frefutable}}
      \end{pfsteps*} 
    \end{byCases}
...
\begin{lemma}
  ...
  \todo{satormay soundness and completeness}
\end{lemma}

...
\begin{proof}
  ...
  \begin{enumerate}
    ...
    \begin{byCases}
      ...
      \begin{byCases}
        \savelocalsteps{1}
        \item[e=\hehole{u},\hhole{e'}{u},\hap{e_1}{e_2},\hmatch{e'}{\zrules},\hprl{e'},\hprr{e'}]
        \begin{pfsteps*}
...
\begin{byCases}
  ...
  \begin{byCases}
    ...
    \item[\hxi=\cpair{\hxi_1}{\hxi_2}]   
    \begin{pfsteps}
    \item \notIntro{\hprl{e}} \BY{\ruleref{rule:NVPrl}} \pflabel{[pair]prl-notintro}
    \item \notIntro{\hprr{e}} \BY{\ruleref{rule:NVPrr}} \pflabel{[pair]prr-notintro}
    \end{pfsteps}
    ...
    \begin{byCases}
      ...
      \item[\true, \true]
      \begin{pfsteps}
      \item \fsatisfy{\hprl{e}}{\hxi_1} = \true \BY{assumption} \pflabel{[pair1]prl-fsatisfy}
      \item \fsatisfy{\hprr{e}}{\hxi_2} = \true \BY{assumption} \pflabel{[pair1]prr-fsatisfy}
      \item \csatisfy{\hprl{e}}{\hxi_1} \BY{\autoref{lem:sound-complete-satisfy} on \pfref{[pair1]prl-fsatisfy}} \pflabel{[pair1]prl-satisfy}
      \item \csatisfy{\hprr{e}}{\hxi_2} \BY{\autoref{lem:sound-complete-satisfy} on \pfref{[pair1]prr-fsatisfy}} \pflabel{[pair1]prr-satisfy}
      \item \csatisfy{e}{\cpair{\hxi_1}{\hxi_2}} \BY{\ruleref{rule:CSNotIntroPair} on \pfref{notintro} and \pfref{[pair1]prl-satisfy} and \pfref{[pair1]prr-satisfy}}
      \end{pfsteps} 
      Contradicts $\cnotsatisfy{e}{\cpair{\hxi_1}{\hxi_2}}$.
      \restorelocalsteps{2} 
      \item[\true, \false]
      \begin{pfsteps}
      \item \fsatisfy{\hprl{e}}{\hxi_1} = \true \BY{assumption} \pflabel{[pair2]prl-fsatisfy}
      \item \fsatisfy{\hprr{e}}{\hxi_2} = \false \BY{assumption} \pflabel{[pair2]prr-fsatisfy}
      \item \cnotsatisfy{\hprr{e}}{\hxi_2} \BY{\autoref{lem:sound-complete-satisfy} on \pfref{[pair2]prr-fsatisfy}} \pflabel{[pair2]prr-satisfy}
      \item \refutable{\hxi_2} \BY{IH on \pfref{[pair]prr-notintro} and \pfref{[pair2]prr-satisfy}} \pflabel{[pair2]refutable2}
      \item \refutable{\cpair{\hxi_1}{\hxi_2}} \BY{\ruleref{rule:RXPairR} on \pfref{[pair2]refutable2}}
      \end{pfsteps} 
      \restorelocalsteps{2}
      \item[\false, \true]
      \begin{pfsteps}
      \item \fsatisfy{\hprl{e}}{\hxi_1} = \false \BY{assumption} \pflabel{[pair3]prl-fsatisfy}
      \item \fsatisfy{\hprr{e}}{\hxi_2} = \true \BY{assumption} \pflabel{[pair3]prr-fsatisfy}
      \item \cnotsatisfy{\hprl{e}}{\hxi_1} \BY{\autoref{lem:sound-complete-satisfy} on \pfref{[pair3]prl-fsatisfy}} \pflabel{[pair3]prl-satisfy}
      \item \refutable{\hxi_1} \BY{IH on \pfref{[pair]prl-notintro} and \pfref{[pair3]prl-satisfy}} \pflabel{[pair3]refutable1}
      \item \refutable{\cpair{\hxi_1}{\hxi_2}} \BY{\ruleref{rule:RXPairL} on \pfref{[pair3]refutable1}}
      \end{pfsteps} 
      \restorelocalsteps{2}
      \item[\false, \false]
      \begin{pfsteps}
      \item \fsatisfy{\hprl{e}}{\hxi_1} = \false \BY{assumption} \pflabel{[pair4]prl-fsatisfy}
      \item \fsatisfy{\hprr{e}}{\hxi_2} = \false \BY{assumption} \pflabel{[pair4]prr-fsatisfy}
      \item \cnotsatisfy{\hprl{e}}{\hxi_1} \BY{\autoref{lem:sound-complete-satisfy} on \pfref{[pair4]prl-fsatisfy}} \pflabel{[pair4]prl-satisfy}
      \item \refutable{\hxi_1} \BY{IH on \pfref{[pair]prl-notintro} and \pfref{[pair4]prl-satisfy}} \pflabel{[pair4]refutable1}
...
\begin{pfsteps*}
    ...
    \item[\text{(\ref{rule:TEHole}),(\ref{rule:THole}),(\ref{rule:TAp}),(\ref{rule:TPrl}),(\ref{rule:TPrr}),(\ref{rule:TMatchZPre}),(\ref{rule:TMatchNZPre})}]
        ...
        \item[\csatisfy{\hprl{e}}{\hxi_1},\cmaysatisfy{\hprr{e}}{\hxi_2}]
            ...
            \item $\refutable{\hxi_2}$ \BY{\autoref{lem:notintro-maysat-or-notsat-refutable} on \pfref{[pair]prr-notintro} and \pfref{[pair2]maysat2}} \pflabel{[pair2]rft2}
        ...
        \item[\cmaysatisfy{\hprl{e}}{\hxi_1},\csatisfy{\hprr{e}}{\hxi_2}]
            ...
            \item $\refutable{\hxi_1}$ \BY{\autoref{lem:notintro-maysat-or-notsat-refutable} on \pfref{[pair]prl-notintro} and \pfref{[pair4]maysat1}} \pflabel{[pair4]rft1}
        ...
        \item[\cmaysatisfy{\hprl{e}}{\hxi_1},\cmaysatisfy{\hprr{e}}{\hxi_2}]
            ...
            \item $\refutable{\hxi_2}$ \BY{\autoref{lem:notintro-maysat-or-notsat-refutable} on \pfref{[pair]prl-notintro} and \pfref{[pair5]maysat1}} \pflabel{[pair5]rft2}
        ...
        \item[\cmaysatisfy{\hprl{e}}{\hxi_1},\cnotsatisfyormay{\hprr{e}}{\hxi_2}]
            ...
            \item $\refutable{\hxi_1}$ \BY{\autoref{lem:notintro-maysat-or-notsat-refutable} on \pfref{[pair]prl-notintro} and \pfref{[pair6]maysat1}} \pflabel{[pair6]rft1}
        ...
        \item[\cnotsatisfyormay{\hprl{e}}{\hxi_1},\cmaysatisfy{\hprr{e}}{\hxi_2}]
            ...
            \item $\refutable{\hxi_2}$ \BY{\autoref{lem:notintro-maysat-or-notsat-refutable} on \pfref{[pair]prr-notintro} and \pfref{[pair8]maysat2}} \pflabel{[pair8]rft2}

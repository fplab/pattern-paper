...
\judgboxa{
  ...
  for $\isFinal{e}$ and $\hexptyp{\cdot}{\Delta}{e}{\tau}$
}
  ...
  \begin{byCases}
    ...
    \begin{pfsteps*}
      ...
      \begin{byCases}
        ...
        \begin{byCases}
          ...
          \item $\cnotsatisfyormay{e_1'}{\hxi_1}$ for any $e_1' \in \expcomplete{e_1}$ \BY{IH on \pfref{[inl]e1indet} and \pfref{[inl]e1typ} and \pfref{[inl]c1typ} and \pfref{[inl]not-satormay1}} \pflabel{[inl]forall1}
          \item $\cnotsatisfyormay{e'}{\cinl{\hxi_1}}$ for any $e' \in \{\hinl{\tau_2}{e_1'} ~\vert~ e_1' \in \expcomplete{e_1}\}$ \BY{\autoref{lem:satormay-inl} on \pfref{[inl]forall1}} \pflabel{[inl]forall}
          \item $\cnotsatisfyormay{e'}{\cinl{\hxi_1}}$ for any $e' \in \expcomplete{\hinl{\tau_2}{e_1}}$ \BY{\autoref{defn:complete} on \pfref{[inl]forall}}
          \end{pfsteps*} 
        \end{byCases}
        \restorelocalsteps{1}
        \item[\text{(\ref{rule:IInr})}] 
        \begin{pfsteps*}
        \item $e=\hinr{\tau_1}{e_2}$ \BY{assumption}
        \item $\cnotsatisfyormay{e'}{\cinl{\hxi_1}}$ for any $e' \in \{\hinr{\tau_1}{e_2'}\}$ \BY{\autoref{lem:inr-notsatormay-inl}} \pflabel{[inr][inl]forallinr}
        \item $\cnotsatisfyormay{e'}{\cinl{\hxi_1}}$ for any $e' \in \{\hinr{\tau_1}{e_2'} ~\vert~ e_2' \in \expcomplete{e_2}\}$ \BY{Weakening on \pfref{[inr][inl]forallinr}} \pflabel{[inr][inl]forallinr'}
        \item $\cnotsatisfyormay{e'}{\cinl{\hxi_1}}$ for any $e' \in \expcomplete{\hinr{\tau_1}{e_2}}$ \BY{\autoref{defn:complete} on \pfref{[inr][inl]forallinr'}}
        \end{pfsteps*}
      \end{byCases} 
    \restorelocalsteps{0}
    ...
    \begin{pfsteps*}
      ...
      \begin{byCases}
        ...
        \begin{pfsteps*}
        \item $e=\hinl{\tau_2}{e_1}$ \BY{assumption}
        \item $\cnotsatisfyormay{e'}{\cinr{\hxi_2}}$ for any $e' \in \{\hinl{\tau_2}{e_1'}\}$ \BY{\autoref{lem:inl-notsatormay-inr}} \pflabel{[inl][inr]forallinl}
        \item $\cnotsatisfyormay{e'}{\cinr{\hxi_2}}$ for any $e' \in \{\hinl{\tau_2}{e_1'} ~\vert~ e_1' \in \expcomplete{e_1}\}$ \BY{Weakening on \pfref{[inl][inr]forallinl}} \pflabel{[inl][inr]forallinl'}
        \item $\cnotsatisfyormay{e'}{\cinr{\hxi_2}}$ for any $e' \in \expcomplete{\hinl{\tau_2}{e_1}}$ \BY{\autoref{defn:complete} on \pfref{[inl][inr]forallinl'}}
        \end{pfsteps*} 
        \restorelocalsteps{1}
        \item[\text{(\ref{rule:IInr})}] 
        \begin{pfsteps*}
        ...
        \begin{byCases}
          ...
          \item $\cnotsatisfyormay{e_2'}{\hxi_2}$ for any $e_2' \in \expcomplete{e_2}$ \BY{IH on \pfref{[inr]e2indet} and \pfref{[inr]e2typ} and \pfref{[inr]c2typ} and \pfref{[inr]not-satormay2}} \pflabel{[inr]forall2}
          \item $\cnotsatisfyormay{e'}{\cinr{\hxi_2}}$ for any $e' \in \{\hinr{\tau_1}{e_2'} ~\vert~ e_2' \in \expcomplete{e_2}\}$ \BY{\autoref{lem:satormay-inr} on \pfref{[inr]forall2}} \pflabel{[inr]forall}
          \item $\cnotsatisfyormay{e'}{\cinr{\hxi_2}}$ for any $e' \in \expcomplete{\hinr{\tau_1}{e_2}}$ \BY{\autoref{defn:complete} on \pfref{[inr]forall}}
          \end{pfsteps*} 
        \end{byCases}
      \end{byCases} 
    \restorelocalsteps{0}
    ...
    \begin{byCases}
      ...
      \item $\expcomplete{e}=\{e' ~\vert~ \isVal{e'} \textand e' : \tprod{\tau_1}{\tau_2}\}$ \BY{\autoref{defn:complete} on \pfref{[pair]notintro}}
      ...
      \begin{byCases}
        ...
        \item $\cnotsatisfyormay{e_1'}{\hxi_1}$ for any $e_1' \in \expcomplete{\hprl{e}}$ \BY{IH on \pfref{[pair]prlindet} and \pfref{[pair]prltyp} and \pfref{[pair]c1typ} and \pfref{[pair]not-satormay1}} \pflabel{[pair]complete1}
        \item $\cnotsatisfyormay{e_1'}{\hxi_1}$ for any $e_1' \in \{e_1' ~\vert~ \isVal{e_1'} \textand e_1' : \tau_1\}$ \BY{\autoref{defn:complete} on \pfref{[pair]complete1}} \pflabel{[pair]complete1'}
        \end{pfsteps*} 
        ...
        \begin{byCases}
          ...
          \begin{byCases}
            ...
            \item $\cnotsatisfyormay{e_1'}{\hxi_1}$ \BY{\pfref{[pair]complete1'} on \pfref{e1'val} and \pfref{e1'typ}} \pflabel{[pair]not-satormay1'}
      ...
      \begin{byCases}
        ...
        \begin{byCases}
          ...
          \item $\cnotsatisfyormay{e_1'}{\hxi_1}$ for any $e_1' \in \expcomplete{e_1}$ \BY{IH on \pfref{[pair1]e1indet} and \pfref{[pair1]e1typ} and \pfref{[pair]c1typ} and \pfref{[pair1]not-satormay-1}} \pflabel{[pair1]complete1}
          \item $\cnotsatisfyormay{\hpair{e_1}{e_2}}{\hpair{\hxi_1}{\hxi_2}}$ for any $e' \in \{\hpair{e_1'}{e_2'} ~\vert~ e_1' \in \expcomplete{e_1} \textand e_2' \in \expcomplete{e_2}\}$ \BY{\autoref{lem:satormay-pair} on \pfref{[pair1]complete1}}
          \end{pfsteps*} 
        \end{byCases}
        \restorelocalsteps{2}
        ...
        \item $\cnotsatisfyormay{e_2'}{\hxi_2}$ for any $e_2' \in \expcomplete{e_2}$ \BY{\autoref{defn:complete} and \pfref{[pair1]not-satormay-2}} \pflabel{[pair1]complete2}
        \item $\cnotsatisfyormay{\hpair{e_1}{e_2}}{\hpair{\hxi_1}{\hxi_2}}$ for any $e' \in \{\hpair{e_1'}{e_2'} ~\vert~ e_1' \in \expcomplete{e_1} \textand e_2' \in \expcomplete{e_2}\}$ \BY{\autoref{lem:satormay-pair} on \pfref{[pair1]complete2}}
        \end{pfsteps*} 
      \end{byCases}
      \restorelocalsteps{1}
      ...
      \begin{byCases}
        ...
        \item $\cnotsatisfyormay{e_1'}{\hxi_1}$ for any $e_1' \in \expcomplete{e_1}$ \BY{\autoref{defn:complete} and \pfref{[pair2]not-satormay-1}} \pflabel{[pair2]complete1}
        \item $\cnotsatisfyormay{\hpair{e_1}{e_2}}{\hpair{\hxi_1}{\hxi_2}}$ for any $e' \in \{\hpair{e_1'}{e_2'} ~\vert~ e_1' \in \expcomplete{e_1} \textand e_2' \in \expcomplete{e_2}\}$ \BY{\autoref{lem:satormay-pair} on \pfref{[pair2]complete1}}
        \end{pfsteps*} 
        \restorelocalsteps{2}
        \item[\cnotsatisfyormay{e_2}{\hxi_2}]
        \begin{pfsteps*}
        ...
        \begin{byCases}
          ...
          \item $\cnotsatisfyormay{e_2'}{\hxi_2}$ for any $e_2' \in \expcomplete{e_2}$ \BY{IH on \pfref{[pair2]e2indet} and \pfref{[pair2]e2typ} and \pfref{[pair]c2typ} and \pfref{[pair2]not-satormay-2}} \pflabel{[pair2]complete2}
          \item $\cnotsatisfyormay{\hpair{e_1}{e_2}}{\hpair{\hxi_1}{\hxi_2}}$ for any $e' \in \{\hpair{e_1'}{e_2'} ~\vert~ e_1' \in \expcomplete{e_1} \textand e_2' \in \expcomplete{e_2}\}$ \BY{\autoref{lem:satormay-pair} on \pfref{[pair2]complete2}}
          \end{pfsteps*} 
        \end{byCases}
      \end{byCases}
      \restorelocalsteps{1}
      ...
      \begin{byCases}
        ...
        \begin{byCases}
          ...
          \item $\cnotsatisfyormay{e_1'}{\hxi_1}$ for any $e_1' \in \expcomplete{e_1}$ \BY{IH on \pfref{[pair3]e1indet} and \pfref{[pair3]e1typ} and \pfref{[pair]c1typ} and \pfref{[pair3]not-satormay-1}} \pflabel{[pair3]complete1}
          \item $\cnotsatisfyormay{\hpair{e_1}{e_2}}{\hpair{\hxi_1}{\hxi_2}}$ for any $e' \in \{\hpair{e_1'}{e_2'} ~\vert~ e_1' \in \expcomplete{e_1} \textand e_2' \in \expcomplete{e_2}\}$ \BY{\autoref{lem:satormay-pair} on \pfref{[pair3]complete1}}
          \end{pfsteps*} 
        \end{byCases}
        \restorelocalsteps{2}
        \item[\cnotsatisfyormay{e_2}{\hxi_2}]
        ...
        \begin{byCases}
          ...
          \item $\cnotsatisfyormay{e_2'}{\hxi_2}$ for any $e_2' \in \expcomplete{e_2}$ \BY{IH on \pfref{[pair3]e2indet} and \pfref{[pair3]e2typ} and \pfref{[pair]c2typ} and \pfref{[pair3]not-satormay-2}} \pflabel{[pair3]complete2}
          \item $\cnotsatisfyormay{\hpair{e_1}{e_2}}{\hpair{\hxi_1}{\hxi_2}}$ for any $e' \in \{\hpair{e_1'}{e_2'} ~\vert~ e_1' \in \expcomplete{e_1} \textand e_2' \in \expcomplete{e_2}\}$ \BY{\autoref{lem:satormay-pair} on \pfref{[pair3]complete2}}
          \end{pfsteps*} 
        \end{byCases}
      \end{byCases}
      \restorelocalsteps{1}
    ...
    \item $\cnotsatisfyormay{e'}{\hxi_1}$ for any $e' \in \expcomplete{e}$ \BY{IH on \pfref{eindet} and \pfref{etyp} and \pfref{[or]c1typ} and \pfref{[or]not-satormay-1}} \pflabel{[or]complete1}
    \item $\cnotsatisfyormay{e'}{\hxi_2}$ for any $e' \in \expcomplete{e}$ \BY{IH on \pfref{eindet} and \pfref{etyp} and \pfref{[or]c2typ} and \pfref{[or]not-satormay-2}} \pflabel{[or]complete2}
    \item $\cnotsatisfyormay{e'}{\cor{\hxi_1}{\hxi_2}}$ for any $e' \in \expcomplete{e}$ \BY{\autoref{lem:satormay-or} on \pfref{[or]complete1} and \pfref{[or]complete2}}
    \end{pfsteps*}
  \end{byCases}
\end{proof}

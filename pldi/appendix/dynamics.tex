  ...
  \begin{byCases}
    ...
    \item[\text{(\ref{rule:FVal})}]
      ...
      \item[\text{(\ref{rule:VNum}) and (\ref{rule:TNum})}]
        ...
        \begin{pfsteps}
        \item \inValues{e'}{\hnum{n'}} \BY{assumption} \pflabel{e'-values-n'}
        \end{pfsteps}
        ...
        \item[\text{(\ref{rule:FVal})}]
          ...
          \begin{byCases}
            ...
            \item[\text{(\ref{rule:VInl}, \ref{rule:TInl})}]
              ...
              \begin{pfsteps}
              \item \inValues{e'}{\hinl{\tau_2}{e_1}} \BY{assumption} \pflabel{[inl-inl]invalues}
              \end{pfsteps}
              ...
              \begin{byCases}
                ...
                \item[\text{(\ref{rule:IVInl})}]
                  \begin{pfsteps}
                  \item e' = \hinl{\tau_2}{e_1'} \BY{assumption}
                  \item \inValues{e_1'}{e_1} \BY{assumption} \pflabel{[inl-inl]invalues1}
            ...
            \item[\text{(\ref{rule:VInr}, \ref{rule:TInr})}]
              ...
              \begin{pfsteps}
              \item \inValues{e'}{\hinr{\tau_1}{e_2}} \BY{assumption} \pflabel{[inl-inr]invalues}
              \end{pfsteps}
    ...
    \begin{pfsteps*}
      ...
      \begin{byCases}
        ...
        \item[\text{(\ref{rule:FVal})}]
          ...
          \begin{byCases}
            ...
            \item[\text{(\ref{rule:VInl}, \ref{rule:TInl})}]
              ...
              \begin{pfsteps}
              \item \inValues{e'}{\hinl{\tau_2}{e_1}} \BY{assumption} \pflabel{[inr-inl]invalues}
              \end{pfsteps}
            ...
            \item[\text{(\ref{rule:VInr}, \ref{rule:TInr})}]
              ...
              \begin{byCases}
                ...
                \item[\text{(\ref{rule:IVInr})}]
                  \begin{pfsteps}
                  \item e' = \hinr{\tau_1}{e_2'} \BY{assumption}
                  \item \inValues{e_2'}{e_2} \BY{assumption} \pflabel{[inr-inr]invalues2}
        ...
        \item[\text{(\ref{rule:IPrl})}]
          \begin{pfsteps*}
          \item $e=\hprl{e_1}$ \BY{assumption}
          \item $\notIntro{\hprl{e_1}}$ \BY{\ruleref{rule:NVPrl}}
            \pflabel{[prl][inr]notintro}
          \item $\cmaysatisfy{\hprl{e_1}}{\cinr{\hxi_2}}$
            \BY{\ruleref{rule:CMSNotIntro} on \pfref{[prl][inr]notintro} and
              \pfref{[inr]refutable}} \pflabel{[prl][inr]maysat}
          \item $\csatisfyormay{\hprl{e_1}}{\cinr{\hxi_2}}$
            \BY{\ruleref{rule:CSMSMay} on \pfref{[prl][inr]maysat}}
          \end{pfsteps*}
          Contradicts \pfref{not-satormay}. \restorelocalsteps{1}
        \item[\text{(\ref{rule:IPrr})}]
          \begin{pfsteps*}
          \item $e=\hprr{e_1}$ \BY{assumption}
          \item $\notIntro{\hprr{e_1}}$ \BY{\ruleref{rule:NVPrr}}
            \pflabel{[prr][inr]notintro}
          \item $\cmaysatisfy{\hprr{e_1}}{\cinr{\hxi_2}}$
            \BY{\ruleref{rule:CMSNotIntro} on \pfref{[prr][inr]notintro} and
              \pfref{[inr]refutable}} \pflabel{[prr][inr]maysat}
          \item $\csatisfyormay{\hprr{e_1}}{\cinr{\hxi_2}}$
            \BY{\ruleref{rule:CSMSMay} on \pfref{[prr][inr]maysat}}
          \end{pfsteps*}
          Contradicts \pfref{not-satormay}. \restorelocalsteps{1}
        \item[\text{(\ref{rule:IMatch})}]
          \begin{pfsteps*}
        ...
        \item[\text{(\ref{rule:IInl})}]
          ...
          \begin{pfsteps*}
          \item $\inValues{e'}{\hinl{\tau_2}{e_1}}$ \BY{assumption}
        ...
        \item[\text{(\ref{rule:IInr})}]
          ...
          \item[\text{(\ref{rule:TInr})}]
            ...
            \begin{pfsteps*}
            \item $\inValues{e'}{\hinr{\tau_1}{e_2}}$ \BY{assumption}
            ...
            \item[\text{(\ref{rule:IVInr})}]
              \begin{pfsteps*}
              \item $e'=\hinr{\tau_1}{e_2'}$ \BY{assumption}
              \item $\inValues{e_2'}{e_2}$ \BY{assumption}
    ...
    \item[\text{(\ref{rule:FVal})}]
      ...
      \item[\text{(\ref{rule:VPair}) and (\ref{rule:TPair})}]
        ...
        \begin{pfsteps}
        \item \inValues{e'}{\hpair{e_1}{e_2}} \BY{assumption} \pflabel{[pair]invalues}
        \end{pfsteps}
        ...
        \item[\text{(\ref{rule:IVPair})}]
          \begin{pfsteps}
          \item e' = \hpair{e_1'}{e_2'} \BY{assumption}
          \item \inValues{e_1'}{e_1} \BY{assumption} \pflabel{[pair]invalues1}
          \item \inValues{e_2'}{e_2} \BY{assumption} \pflabel{[pair]invalues2}
          \item \cnotsatisfyormay{e_1}{\hxi_1}
          ...
          \begin{byCases}
            ...
            \begin{byCases}
              ...
              \begin{byCases}
                ...
                \item $\refutable{\hxi_2}$ \BY{\autoref{lem:notintro-maysat-or-notsat-refutable} on \pfref{[pair]prrnotintro} and \pfref{[pair]maysat2}} \pflabel{[pair]refutable2}
              ...
              \item $\refutable{\hxi_1}$ \BY{\autoref{lem:notintro-maysat-or-notsat-refutable} on \pfref{[pair]prlnotintro} and \pfref{[pair]maysat1}} \pflabel{[pair]refutable1}
  ...
  \item[\text{(\ref{rule:CSMSSat})}]
    ...
    \item[\text{(\ref{rule:CSTruth})}]
      ...
      \item[\text{(\ref{rule:FVal})}]
        ...
        \item \inValues{e}{e} \BY{\ruleref{rule:IVVal} on \pfref{[truth]eval}} \pflabel{[truth]invalues}
        \end{pfsteps}
      ...
      \item[\text{(\ref{rule:FIndet})}]
        ...
        \item \inValues{e'}{e} \text{ for fresh $e'$} \BY{\autoref{lem:invalues-derivable}}\pflabel{[truth]e'invalues}
    ...
    \item[\text{(\ref{rule:CSNum})}]
      ...
      \item \inValues{\hnum{n}}{\hnum{n}} \BY{\ruleref{rule:IVVal} on
    ...
    \item[\text{(\ref{rule:CSInl})}]
      ...
      \item \inValues{e_1'}{e_1} \text{ for fresh $e_1'$} \BY{IH on \pfref{[inl]c1typ},
      ...
      \item \inValues{\hinl{\tau_2}{e_1'}}{\hinl{\tau_2}{e_1}}
    ...
    \item[\text{(\ref{rule:CSInr})}]
      ...
      \item \inValues{e_2'}{e_2} \text{ for fresh $e_2'$} \BY{IH on \pfref{[inr]c2typ},
      ...
      \item \inValues{\hinr{\tau_1}{e_2'}}{\hinr{\tau_1}{e_2}}
    ...
    \item[\text{(\ref{rule:CSPair})}]
      ...
      \item \inValues{e_1'}{e_1} \text{ for fresh $e_1'$} \BY{IH on \pfref{[pair]c1typ},
      ...
      \item \inValues{e_2'}{e_2} \text{ for fresh $e_2'$} \BY{IH on \pfref{[pair]c2typ},
      ...
      \item \inValues{\hpair{e_1'}{e_2'}}{\hpair{e_1}{e_2}}
    ...
    \item[\text{(\ref{rule:CSNotIntroPair})}]
      ...
      \item \csatisfy{\hprl{e}}{\hxi_1} \BY{assumption} \pflabel{[notintro]satisfy1}
      \item \csatisfy{\hprr{e}}{\hxi_2} \BY{assumption} \pflabel{[notintro]satisfy2}
      \item \csatisfyormay{\hprl{e}}{\hxi_1} \BY{\ruleref{rule:CSMSSat} on
          \pfref{[notintro]satisfy1}} \pflabel{[notintro]satormay1}
      \item \csatisfyormay{\hprr{e}}{\hxi_2} \BY{\ruleref{rule:CSMSSat} on
      ...
      \item \hexptyp{\cdot}{\Delta}{\hprl{e}}{\tau_1} \BY{\ruleref{rule:TPrl} on
        \pfref{etyp}} \pflabel{[notintro]e1typ}
    \item \hexptyp{\cdot}{\Delta}{\hprr{e}}{\tau_2} \BY{\ruleref{rule:TPrr} on
        \pfref{etyp}} \pflabel{[notintro]e2typ}
      \item \isIndet{\hprl{e}} \BY{\ruleref{rule:IPrl} on \pfref{efinal}} \pflabel{[notintro]e1indet}
      \item \isFinal{\hprl{e}} \BY{\ruleref{rule:FIndet} on \pfref{[notintro]e1indet}} \pflabel{[notintro]e1final}
      \item \isIndet{\hprr{e}} \BY{\ruleref{rule:IPrr} on \pfref{efinal}} \pflabel{[notintro]e2indet}
      \item \isFinal{\hprr{e}} \BY{\ruleref{rule:FIndet} on \pfref{[notintro]e2indet}} \pflabel{[notintro]e2final}
      \item \inValues{e_1'}{\hprl{e}} \text{ for fresh $e_1'$} \BY{IH on \pfref{[notintro]c1typ},
      ...
      \item \inValues{e_2'}{\hprr{e}} \text{ for fresh $e_2'$} \BY{IH on \pfref{[notintro]c2typ},
    ...
    \item[\text{(\ref{rule:CSOr1})}]
      ...
      \item \inValues{e'}{e} \text{ for fresh $e'$} \BY{IH on \pfref{[or1]c1typ},
    ...
    \item[\text{(\ref{rule:CSOr2})}]
      ...
      \item \inValues{e'}{e} \text{ for fresh $e'$} \BY{IH on \pfref{[or2]c2typ},
  ...
  \item[\text{(\ref{rule:CSMSMay})}]
    ...
    \item[\text{(\ref{rule:CMSUnknown})}]
      ...
      \item[\text{(\ref{rule:FVal})}]
        ...
        \item \inValues{e}{e} \BY{\ruleref{rule:IVVal} on \pfref{[unknown]eval}} \pflabel{[unknown]invalues}
        \end{pfsteps}
      ...
      \item[\text{(\ref{rule:FIndet})}]
        ...
        \item \inValues{e'}{e} \text{ for fresh $e'$} \BY{\autoref{lem:invalues-derivable}}\pflabel{[unknown]e'invalues}
    ...
    \item[\text{(\ref{rule:CMSPair1})}]
      ...
      \item \inValues{e_1'}{e_1} \text{ for fresh $e_1'$} \BY{IH on \pfref{[pair1]c1typ},
      ...
      \item \inValues{e_2'}{e_2} \text{ for fresh $e_2'$} \BY{IH on \pfref{[pair1]c2typ},
    ...
    \item[\text{(\ref{rule:CMSPair2})}]
      ...
      \item \inValues{e_1'}{e_1} \text{ for fresh $e_1'$} \BY{IH on \pfref{[pair2]c1typ},
      ...
      \item \inValues{e_2'}{e_2} \text{ for fresh $e_2'$} \BY{IH on \pfref{[pair2]c2typ},
    ...
    \item[\text{(\ref{rule:CMSPair3})}]
      ...
      \item \inValues{e_1'}{e_1} \text{ for fresh $e_1'$} \BY{IH on \pfref{[pair3]c1typ},
      ...
      \item \inValues{e_2'}{e_2} \text{ for fresh $e_2'$} \BY{IH on \pfref{[pair3]c2typ},
    ...
    \item[\text{(\ref{rule:CMSNotIntro})}]
      ...
      \item \inValues{e'}{e} \BY{\ref{rule:IVIndet} on
          \pfref{[notintro]notintro} and \pfref{etyp} and \pfref{[notintro]e'val} and
          \pfref{[notintro]e'typ}}
      \end{pfsteps}
      $e'$ is such an expression that $\inValues{e'}{e}$ and $\csatisfyormay{e'}{\hxi}$.
    \end{byCases}
  \end{byCases}
  \resetpfcounter
\end{proof}

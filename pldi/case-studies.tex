...
\begin{figure}[h]
  ...
  \subfloat[May or may not be exhaustive.\label{fig:may-exhaustive}]{
    \includegraphics[scale=0.5]{esop/imgs/maybe_exhaustive.png}
}
\hfill
  \subfloat[Must not be exhaustive.\label{fig:not-exhautive}]{
\includegraphics[scale=0.5]{esop/imgs/not_exhaustive.png}
}
...
\begin{figure}[h]
  \centering
    ...
    \includegraphics[scale=0.5]{esop/imgs/maybe_redundant.png}
    } 
    \hfill
  \subfloat[Must be redundant. \label{fig:must-redundant}]{
  \includegraphics[scale=0.5]{esop/imgs/redundant.png}
  }%
...
\begin{figure}[h]
\centering
\subfloat[Pattern matching with expression  holes.\label{fig:exp-hole}]{\includegraphics[scale=0.47]{esop/imgs/pat_match_exp_holes.png}}
\hfill

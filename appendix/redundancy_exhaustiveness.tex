...
\begin{lem}[Soundness and Completeness of Satisfaction Judgment]
  ...
  $\csatisfy{e}{\xi}$ iff $\fsatisfy{e}{\xi}$ returns true.
\end{lem}
\begin{proof}
  ...
  \begin{enumerate}
    \item Soundness:
      ...
      \item[\text{(\ref{rule:CSTruth})}]
        ...
        \item $\fsatisfy{e}{\ctruth} = \text{true}$ \BY{Definition \ref{defn:satisfy-truth}}
        \end{pfsteps*}
      ...
      \item[\text{(\ref{rule:CSNum})}]
        ...
        \item $\fsatisfy{\hnum{n}}{\cnum{n}} = (n==n) = \text{true}$ \BY{Definition \ref{defn:num-satisfy-num}}
        \end{pfsteps*}

...
\begin{subequations}\label{rules:notval}
...
\end{equation}
\begin{equation}\label{rule:MNotValPair}
\inferrule[MNotValPair]{
  \isntVal{e} \\
...
\end{equation}
\begin{equation}\label{rule:MMNotVal}
\inferrule[MMNotVal]{
  \isntVal{e} \\
  \refutable{p}
}{
...
\begin{lemma}
  \label{lem:no-num-notval}
  There doesn't exist $\hnum{n}$ such that $\isntVal{\hnum{n}}$.
\end{lemma}
\begin{proof}
    By rule induction over Rules (\ref{rules:notval}) on $\isntVal{\hnum{n}}$, no case applies due to syntactic contradiction.
\end{proof}

\begin{lemma}
  \label{lem:no-inl-notval}
  There doesn't exist $\hinl{\tau}{e}$ such that $\isntVal{\hinl{\tau}{e}}$.
\end{lemma}
\begin{proof}
    By rule induction over Rules (\ref{rules:notval}) on $\isntVal{\hinl{\tau}{e}}$, no case applies due to syntactic contradiction.
\end{proof}

\begin{lemma}
  \label{lem:no-inr-notval}
  There doesn't exist $\hinr{\tau}{e}$ such that $\isntVal{\hinr{\tau}{e}}$.
\end{lemma}
\begin{proof}
    By rule induction over Rules (\ref{rules:notval}) on $\isntVal{\hinr{\tau}{e}}$, no case applies due to syntactic contradiction.
\end{proof}

\begin{lemma}
  \label{lem:no-pair-notval}
  There doesn't exist $\hpair{e_1}{e_2}$ such that $\isntVal{\hpair{e_1}{e_2}}$.
\end{lemma}
\begin{proof}
    By rule induction over Rules (\ref{rules:notval}) on $\isntVal{\hpair{e_1}{e_2}}$, no case applies due to syntactic contradiction.
\end{proof}

\begin{lemma}
  \label{lem:final-notval-indet}
  If $\isFinal{e}$ and $\isntVal{e}$ then $\isIndet{e}$.
\end{lemma}
\begin{proof}[Proof Sketch]
By rule induction over Rules (\ref{rules:notval}) on  $\isntVal{e}$, for each case, by rule induction over Rules (\ref{rules:Value}) on $\isVal{e}$ and we notice that $\isVal{e}$ is not derivable. By rule induction over Rules (\ref{rules:Final}) on $\isFinal{e}$, Rule (\ref{rule:FVal}) result in a contradiction with the fact that $\isVal{e}$ is not derivable while Rule (\ref{rule:FIndet}) tells us $\isIndet{e}$.
\end{proof}
...
\item[\text{(\ref{rule:PTNum})}]
    ...
    \item[\text{(\ref{rule:TEHole}),(\ref{rule:THole}),(\ref{rule:TAp}),(\ref{rule:TPrl}),(\ref{rule:TPrr}),(\ref{rule:TMatchZPre}),(\ref{rule:TMatchNZPre})}]
        ...
        \item $\hmaymatch{e}{\hnum{n_2}}$ \BY{\ruleref{rule:CMSNotVal} on \pfref{[num]rft} and \pfref{[num]notval}}
        \end{pfsteps*}
...
\item[\text{(\ref{rule:PTInl})}]
    ...
    \item[\text{(\ref{rule:TEHole}),(\ref{rule:THole}),(\ref{rule:TAp}),(\ref{rule:TPrl}),(\ref{rule:TPrr}),(\ref{rule:TMatchZPre}),(\ref{rule:TMatchNZPre})}]
        ...
        \item $\hmaymatch{e}{\hinlp{p_1}}$ \BY{\ruleref{rule:CMSNotVal} on \pfref{[inl]rft} and \pfref{[inl]notval}}
        \end{pfsteps*}
    ...
    \item[\text{(\ref{rule:TInl})}]
        ...
        \item[\hpatmatch{e_1}{p_1}{\theta_1}]
            ...
            \item[\text{(\ref{rule:MMNotVal})}]
                \begin{pfsteps*}
                \item $\isntVal{\hinl{\tau_2}{e_1}}$ \BY{assumption}
                \end{pfsteps*}
                Contradicts \autoref{lem:no-inl-notval}.
            \restorelocalsteps{3}
...
\item[\text{(\ref{rule:PTInr})}]
    ...
    \item[\text{(\ref{rule:TEHole}),(\ref{rule:THole}),(\ref{rule:TAp}),(\ref{rule:TPrl}),(\ref{rule:TPrr}),(\ref{rule:TMatchZPre}),(\ref{rule:TMatchNZPre})}]
        ...
        \item $\hmaymatch{e}{\hinrp{p_2}}$ \BY{\ruleref{rule:CMSNotVal} on \pfref{[inr]rft} and \pfref{[inr]notval}}
        \end{pfsteps*}
    ...
    \item[\text{(\ref{rule:TInr})}]
        ...
        \item[\hpatmatch{e_2}{p_2}{\theta_2}]
            ...
            \item[\text{(\ref{rule:MMNotVal})}]
                \begin{pfsteps*}
                \item $\isntVal{\hinr{\tau_1}{e_2}}$ \BY{assumption}
                \end{pfsteps*}
                Contradicts \autoref{lem:no-inr-notval}.
            \restorelocalsteps{3}
...
\item[\text{(\ref{rule:PTPair})}]
    ...
    \item[\text{(\ref{rule:TEHole}),(\ref{rule:THole}),(\ref{rule:TAp}),(\ref{rule:TPrl}),(\ref{rule:TPrr}),(\ref{rule:TMatchZPre}),(\ref{rule:TMatchNZPre})}]
        \begin{pfsteps*}
        \item $e=\hehole{u},\hhole{e_0}{u},\hap{e_1}{e_2},\hprl{e_0},\hprr{e_0},\hmatch{e_0}{\zrules}$ \BY{assumption}
        \item $\isntVal{e}$ \BY{Rule (\ref{rule:NVEHole}),(\ref{rule:NVHole}),(\ref{rule:NVAp}),(\ref{rule:NVMatch}),(\ref{rule:NVPrl}),(\ref{rule:NVPrr})} \pflabel{[epair]notval}
        \item $\isIndet{e}$ \BY{\autoref{lem:final-notval-indet} on \pfref{e-final} and \pfref{[epair]notval}} \pflabel{[epair]indet}
        ...
        \item[\hpatmatch{\hprl{e}}{p_1}{\theta_1},\hpatmatch{\hprr{e}}{p_2}{\theta_2}]
            ...
            \item $\hpatmatch{e}{\hpair{p_1}{p_2}}{\theta_1 \uplus \theta_2}$ \BY{\ruleref{rule:MNotValPair} on \pfref{[epair]notval} and \pfref{[epair1]match1} and \pfref{[epair1]match2}}
            \end{pfsteps*}
            ...
            \item[\text{(\ref{rule:MMNotVal})}]
                ...
                \item[\text{(\ref{rule:RPairL})}]
                    ...
                    \item $\isntVal{\hprl{e}}$ \BY{\ruleref{rule:NVPrl}} \pflabel{[epair1]notval-prl}
                    \item $\hmaymatch{\hprl{e}}{p_1}$ \BY{\ruleref{rule:MMNotVal} on \pfref{[epair1]rft-p1} and \pfref{[epair1]notval-prl}}
                    \end{pfsteps*}
                ...
                \item[\text{(\ref{rule:RPairR})}]
                    ...
                    \item $\isntVal{\hprr{e}}$ \BY{\ruleref{rule:NVPrr}} \pflabel{[epair1]notval-prr}
                    \item $\hmaymatch{\hprl{e}}{p_1}$ \BY{\ruleref{rule:MMNotVal} on \pfref{[epair1]rft-p2} and \pfref{[epair1]notval-prr}}
                    \end{pfsteps*}
                    Contradicts \pfref{[epair1]not-maymatch1}.
                \end{byCases}
            \end{byCases}
        ...
        \item[\hpatmatch{\hprl{e}}{p_1}{\theta_1},\hmaymatch{\hprr{e}}{p_2}]
            ...
            \item[\text{(\ref{rule:MMEHole}),(\ref{rule:MMHole})}]
                ...
                \item $\hmaymatch{e}{\hpair{p_1}{p_2}}$ \BY{\ruleref{rule:MMNotVal} on \pfref{[epair]notval} and \pfref{[epair2]rft-pair}}
                \end{pfsteps*}
            \restorelocalsteps{3}
            \item[\text{(\ref{rule:MMNotVal})}]
                \begin{pfsteps*}
        ...
        \item[\hmaymatch{\hprl{e}}{p_1},\hpatmatch{\hprr{e}}{p_2}{\theta_2}]
            ...
            \item[\text{(\ref{rule:MMEHole}),(\ref{rule:MMHole})}]
                ...
                \item $\hmaymatch{e}{\hpair{p_1}{p_2}}$ \BY{\ruleref{rule:MMNotVal} on \pfref{[epair]notval} and \pfref{[epair4]rft-pair}}
                \end{pfsteps*}
            \restorelocalsteps{3}
            \item[\text{(\ref{rule:MMNotVal})}]
                \begin{pfsteps*}
        ...
        \item[\hmaymatch{\hprl{e}}{p_1},\hmaymatch{\hprr{e}}{p_2}]
            ...
            \item[\text{(\ref{rule:MMEHole}),(\ref{rule:MMHole})}]
                ...
                \item $\hmaymatch{e}{\hpair{p_1}{p_2}}$ \BY{\ruleref{rule:MMNotVal} on \pfref{[epair]notval} and \pfref{[epair5]rft-pair}}
                \end{pfsteps*}
            \restorelocalsteps{3}
            \item[\text{(\ref{rule:MMNotVal})}]
                \begin{pfsteps*}
...
\item[\text{(\ref{rule:PTNum})}]
    ...
    \item Prove $\cmaysatisfy{e}{\cnum{n}}$ implies $\hmaymatch{e}{\hnum{n}}$.
        ...
        \item[\text{(\ref{rule:CMSNotVal})}]
            \begin{pfsteps*}
            \item $\isntVal{e}$ \BY{assumption} \pflabel{[num]notnum}
            \item $\refutable{\hnum{n}}$ \BY{\ruleref{rule:RNum}} \pflabel{[num]rft}
            \item $\hmaymatch{e}{\hnum{n}}$ \BY{\ruleref{rule:MMNotVal} on \pfref{[num]notnum} and \pfref{[num]rft}}
            \end{pfsteps*}
        \end{byCases}
    \restorelocalsteps{1}
...
\item[\text{(\ref{rule:PTInl})}]
    ...
    \item[\text{(\ref{rule:TEHole}),(\ref{rule:THole}),(\ref{rule:TAp}),(\ref{rule:TPrl}),(\ref{rule:TPrr}),(\ref{rule:TMatchZPre}),(\ref{rule:TMatchNZPre})}]
        ...
        \item Prove $\cmaysatisfy{e}{\cinl{\xi_1}}$ implies $\hmaymatch{e}{\hinlp{p_1}}$.
            \begin{pfsteps*}
            \item $\refutable{\hinlp{p_1}}$ \BY{\ruleref{rule:RInl}} \pflabel{[inl]rft}
            \item $\hmaymatch{e}{\hinlp{p_1}}$ \BY{\ruleref{rule:MMNotVal} on \pfref{[inl]notval} and \pfref{[inl]rft}}
            \end{pfsteps*}
        \restorelocalsteps{2}
        \item Prove $\hmaymatch{e}{\hinlp{p_1}}$ implies $\cmaysatisfy{e}{\cinl{\xi_1}}$.
            ...
            \item $\cmaysatisfy{e}{\cinl{\xi_1}}$ \BY{\ruleref{rule:CMSNotVal} on \pfref{[inl]notval} and \pfref{[inl]xi-rft}}
            \end{pfsteps*}
        \end{enumerate}
    \restorelocalsteps{1}
    \item[\text{(\ref{rule:TInl})}]
...
\item[\text{(\ref{rule:PTInr})}]
    ...
    \item[\text{(\ref{rule:TEHole}),(\ref{rule:THole}),(\ref{rule:TAp}),(\ref{rule:TPrl}),(\ref{rule:TPrr}),(\ref{rule:TMatchZPre}),(\ref{rule:TMatchNZPre})}]
        ...
        \item Prove $\cmaysatisfy{e}{\cinr{\xi_2}}$ implies $\hmaymatch{e}{\hinrp{p_2}}$.
            \begin{pfsteps*}
            \item $\refutable{\hinrp{p_2}}$ \BY{\ruleref{rule:RInr}} \pflabel{[inr]rft}
            \item $\hmaymatch{e}{\hinrp{p_2}}$ \BY{\ruleref{rule:MMNotVal} on \pfref{[inr]notval} and \pfref{[inr]rft}}
            \end{pfsteps*}
        \restorelocalsteps{2}
        \item Prove $\hmaymatch{e}{\hinrp{p_2}}$ implies $\cmaysatisfy{e}{\cinr{\xi_2}}$.
            ...
            \item $\cmaysatisfy{e}{\cinr{\xi_2}}$ \BY{\ruleref{rule:CMSNotVal} on \pfref{[inr]notval} and \pfref{[inr]xi-rft}}
            \end{pfsteps*}
        \end{enumerate}
    \restorelocalsteps{1}
    \item[\text{(\ref{rule:TInr})}]
...
\item[\text{(\ref{rule:PTPair})}]
    ...
    \item[\text{(\ref{rule:TEHole}),(\ref{rule:THole}),(\ref{rule:TAp}),(\ref{rule:TPrl}),(\ref{rule:TPrr}),(\ref{rule:TMatchZPre}),(\ref{rule:TMatchNZPre})}]
        ...
        \item $e=\hehole{u},\hhole{e_0}{u},\hap{e_1}{e_2},\hprl{e_0},\hprr{e_0},\hmatch{e_0}{\zrules}$ \BY{assumption}
        \item $\isntVal{e}$ \BY{Rule (\ref{rule:NVEHole}),(\ref{rule:NVHole}),(\ref{rule:NVAp}),(\ref{rule:NVMatch}),(\ref{rule:NVPrl}),(\ref{rule:NVPrr})} \pflabel{[epair]notval}
        \item $\isIndet{e}$ \BY{\autoref{lem:final-notval-indet} on \pfref{eFinal} and \pfref{[epair]notval}} \pflabel{[epair]indet}
        \item $\isIndet{\hprl{e}}$ \BY{Rule (\ref{rule:IPrl}) on \pfref{[epair]indet}} \pflabel{[epair]prl-indet}
        \item $\isFinal{\hprl{e}}$ \BY{Rule (\ref{rule:FIndet}) on \pfref{[epair]prl-indet}} \pflabel{[epair]prl-final}
        \item $\isIndet{\hprr{e}}$ \BY{Rule (\ref{rule:IPrr}) on \pfref{[epair]indet}} \pflabel{[epair]prr-indet}
        \item $\isFinal{\hprr{e}}$ \BY{Rule (\ref{rule:FIndet}) on \pfref{[epair]prr-indet}} \pflabel{[epair]prr-final}
        ...
        \item Prove $\hpatmatch{e}{\hpair{p_1}{p_2}}{\theta}$ implies $\csatisfy{e}{\cpair{\xi_1}{\xi_2}}$.
            ...
            \item[\text{(\ref{rule:MNotValPair})}]
                ...
                \item $\csatisfy{e}{\cpair{\xi_1}{\xi_2}}$ \BY{\ruleref{rule:CSNotValPair} on \pfref{[epair]notval} and \pfref{[epair2]satisfy1} and \pfref{[epair2]satisfy2}}
                \end{pfsteps*}
            \end{byCases}
        \restorelocalsteps{2}
        \item Prove $\cmaysatisfy{e}{\cpair{\xi_1}{\xi_2}}$ implies $\hmaymatch{e}{\hpair{p_1}{p_2}}$.
            ...
            \item[\text{(\ref{rule:CMSNotVal})}]
                ...
                \item[\text{(\ref{rule:RXPairL})}]
                    ...
                    \item $\isntVal{\hprl{e}}$ \BY{\ruleref{rule:NVPrl}} \pflabel{[epair3]notval1}
                    \item $\cmaysatisfy{\hprl{e}}{\xi_1}$ \BY{\ruleref{rule:CMSNotVal} on \pfref{[epair3]rft1} and \pfref{[epair3]notval1}} \pflabel{[epair3]satisfy1}
                    ...
                    \item[\text{(\ref{rule:MMEHole}),(\ref{rule:MMHole})}]
                        ...
                        \item $\hmaymatch{e}{\hpair{p_1}{p_2}}$ \BY{\ruleref{rule:MMNotVal} on \pfref{[epair]notval} and \pfref{[epair3]p-rft}}
                        \end{pfsteps*}
                    \restorelocalsteps{4}
                    \item[\text{(\ref{rule:MMNotVal})}]
                        \begin{pfsteps*}
                ...
                \item[\text{(\ref{rule:RXPairR})}]
                    ...
                    \item $\isntVal{\hprr{e}}$ \BY{\ruleref{rule:NVPrl}} \pflabel{[epair3']notval1}
                    \item $\cmaysatisfy{\hprr{e}}{\xi_2}$ \BY{\ruleref{rule:CMSNotVal} on \pfref{[epair3']rft1} and \pfref{[epair3']notval1}} \pflabel{[epair3']satisfy1}
        ...
        \item Prove $\hmaymatch{e}{\hpair{p_1}{p_2}}$ implies $\cmaysatisfy{e}{\cpair{\xi_1}{\xi_2}}$.
            ...
            \item[\text{(\ref{rule:MMNotVal})}]
                ...
                \item[\text{(\ref{rule:RPairL})}]
                    ...
                    \item $\isntVal{\hprl{e}}$ \BY{\ruleref{rule:NVPrl}} \pflabel{[epair4]notval1}
                    \item $\hmaymatch{\hprl{e}}{p_1}$ \BY{\ruleref{rule:MMNotVal} on \pfref{[epair4]rft1} and \pfref{[epair4]notval1}} \pflabel{[epair4]match1}
                    ...
                    \item[\text{(\ref{rule:CMSUnknown})}]
                        ...
                        \item $\cmaysatisfy{e}{\cpair{\xi_1}{\xi_2}}$ \BY{\ruleref{rule:CMSNotVal} on \pfref{[epair]notval} and \pfref{[epair4]p-rft}}
                        \end{pfsteps*}
                    \restorelocalsteps{4}
                    \item[\text{(\ref{rule:CMSNotVal})}]
                        \begin{pfsteps*}
                ...
                \item[\text{(\ref{rule:RPairR})}]
                    ...
                    \item $\isntVal{\hprr{e}}$ \BY{\ruleref{rule:NVPrl}} \pflabel{[epair4']notval1}
                    \item $\hmaymatch{\hprr{e}}{p_2}$ \BY{\ruleref{rule:MMNotVal} on \pfref{[epair4']rft1} and \pfref{[epair4']notval1}} \pflabel{[epair4']satisfy1}

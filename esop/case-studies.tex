...
\begin{figure}[h]
  ...
  \subfloat[May or may not be exhaustive.\label{fig:may-exhaustive}]{
    \includegraphics[scale=0.4]{esop/imgs/maybe_exhaustive1.png}
}
\hfill
  \subfloat[Must not be exhaustive.\label{fig:not-exhautive}]{
\includegraphics[scale=0.4]{esop/imgs/not_exhaustive1.png}
}
...
\begin{figure}[h]
  \centering
    ...
    \includegraphics[scale=0.4]{esop/imgs/maybe_redundant1.png}
    } 
    \hfill
  \subfloat[Must be redundant. \label{fig:must-redundant}]{
  \includegraphics[scale=0.4]{esop/imgs/redundant1.png}
  }%
...
\begin{figure}[h]
\centering
\subfloat[Pattern matching with expression  holes.\label{fig:exp-hole}]{\includegraphics[scale=0.37]{esop/imgs/pat_match_exp_holes1.png}}
\hfill
\subfloat[Pattern matching with pattern holes.\label{fig:pat-hole}]{\includegraphics[scale=0.47]{esop/imgs/pat_match_pat_holes.png}}

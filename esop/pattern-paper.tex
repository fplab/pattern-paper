...
\textit{key concept}
\todo{d: if anything, the concept itself should be emphasized, not the phrase ``key concept''}
...
in a non-empty hole.
\todo{say more about what this gives you in terms of continuity
when combined with Hazelnut}
...
\todo{something something simple types}
\todo{say something about the corresponding extensions to Hazelnut
being more straightforward, subtleties are in dynamic semantics}
\todo{mention typed holes in Haskell, Agda}

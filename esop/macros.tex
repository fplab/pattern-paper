...
\newcommand{\hprl}[1]{\mathtt{prl}(#1)}
\newcommand{\hprr}[1]{\mathtt{prr}(#1)}
...
\newcommand{\refutable}[1]{#1 ~\mathtt{refutable}}
\newcommand{\frefutable}[1]{\textit{refutable}\inparens{#1}}
...
\newcommand{\isntVal}[1]{#1 ~\mathtt{notval}}
...
\newcommand{\cnotsatisfy}[2]{#1 \not\models #2}
\newcommand{\cmaysatisfy}[2]{#1 \models_{?} #2}
\newcommand{\cnotmaysatisfy}[2]{#1 \not\models_{?} #2}
\newcommand{\csatisfyormay}[2]{#1 \models_{?}^{\dag} #2}
\newcommand{\cnotsatisfyormay}[2]{#1 \not\models_{?}^{\dag} #2}
\newcommand{\cincon}[1]{#1 ~\mathtt{incon}}
\newcommand{\cmayincon}[1]{#1 ~\cancel{\mathtt{not~incon}}}

\newcommand{\cpattyp}[4]{#1 : #2 [#3] \dashV #4}
\newcommand{\chpattyp}[5]{#1 : #2 [#3] \dashV #4 \mathbin{;} #5}

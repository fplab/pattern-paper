...
let%test "exhaustive1" = is_exhaustive @@ list_reduce cor [ Inl Truth; Inr Truth ] = true

let%test "exhaustive2" = is_exhaustive @@ list_reduce cor [ Inl Truth; Inr Unknown ] = true

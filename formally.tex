...
\begin{subequations}\label{rules:satormayConst}
...
\begin{defn}[Entailment of Constraints]
  ...
  $\csatisfy{\xi_1}{\xi_2}$ iff $\csatisfyormay{e}{\xi_1}$ implies $\csatisfy{e}{\xi_2}$ for all $e$ such that $\hexptyp{\cdot}{\cdot}{e}{\tau}$ and $\ctyp{\xi_1}{\tau}$ and $\ctyp{\xi_2}{\tau}$
\end{defn}

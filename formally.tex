...
\begin{defn}[Undeterministic Material Entailment of Constraints]
...
\begin{figure}[p]
  \fbox{$\rmpointer{\hat{rs}} = rs$}~~\text{erase pointer from $\hat{rs}$}
\begin{subequations}
\begin{align}
...
\begin{figure}[p]
  \fbox{$\czrulstyp{\Gamma}{\Delta}{\xi}{\zruls{rs}{r}{rs'}}{\xi'}{\tau}{\tau'}$}~~\text{}
\begin{subequations}
\begin{equation}
\inferrule[CTOneRule]{
  \chrultyp{\Gamma}{\Delta}{r}{\tau}{\xi_r}{\tau'} \\
  \cnotsatisfy{\xi_r}{\xi_{rs}}
}{
  \czrulstyp{\Gamma}{\Delta}{\xi_{rs}}{\zruls{rs}{r}{\cdot}}{\xi_r}{\tau}{\tau'}
}
\end{equation}
\begin{equation}
\inferrule[CTRules]{
  \chrultyp{\Gamma}{\Delta}{r}{\tau}{\xi}{\tau'} \\
  \czrulstyp{\Gamma}{\Delta}{\cor{\xi'}{\xi}}{
    \zruls{\rmpointer{\zruls{rs}{r}{\cdot}}}
  {r'}{rs'}
}
  {\xi''}{\tau}{\tau'} \\
  \cnotsatisfy{\xi}{\xi'}
}{
  \czrulstyp{\Gamma}{\Delta}{\xi'}{\zruls{rs}{r}{\hrulesP{r'}{rs'}}}
  {\cor{\xi}{\xi''}}{\tau}{\tau'}
}
\end{equation}
\end{subequations}
...
\inferrule[CTMatch]{
  ...
  \czrulstyp{\Gamma}{\Delta}{\cfalsity}{\hat{rs}}{\xi}{\tau}{\tau'} \\
...
\begin{lem}[Exhaustive Matching Progress when e is a value]
  ...
  If $\isVal{e}$ and $\hexptyp{\cdot}{\Delta}{e}{\tau}$ and $\czrulstyp{\cdot}{\Delta}{\xi}{\zrules}{\xi'}{\tau}{\tau'}$ and $\csatisfy{\ctruth}{\cor{\xi}{\xi'}}$
  then either
  \begin{enumerate}
    \item $\csatisfy{e}{\xi}$

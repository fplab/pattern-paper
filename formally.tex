...
\end{equation}
\begin{equation}
\inferrule[MMExpEHolePair]{ }{
  \hmaymatch{\hehole{u}}{\hpair{p_1}{p_2}}
}
\end{equation}
\begin{equation}
\inferrule[MMExpEHoleTriv]{ }{
  \hmaymatch{\hehole{u}}{\htriv}
}
\end{equation}
\begin{equation}
\inferrule[MMExpEHoleInL]{ }{
  \hmaymatch{\hehole{u}}{\hinlp{p}}
}
\end{equation}
\begin{equation}
\inferrule[MMExpEHoleInR]{ }{
  \hmaymatch{\hehole{u}}{\hinrp{p}}
}
\end{equation}
\begin{equation}
\inferrule[MMExpHolePair]{ }{
  \hmaymatch{\hhole{e}{u}}{\hpair{p_1}{p_2}}
}
\end{equation}
\begin{equation}
\inferrule[MMExpHoleTriv]{ }{
  \hmaymatch{\hhole{e}{u}}{\htriv}
}
\end{equation}
\begin{equation}
\inferrule[MMExpHoleInL]{ }{
  \hmaymatch{\hhole{e}{u}}{\hinlp{p}}
}
\end{equation}
\begin{equation}
\inferrule[MMExpHoleInR]{ }{
  \hmaymatch{\hhole{e}{u}}{\hinrp{p}}
}
\end{equation}
\begin{equation}
\inferrule[MMPair1]{

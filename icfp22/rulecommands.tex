...
\newrulecommand{NMInjArgOne}{NMInjArg1}
\newrulecommand{NMInjArgTwo}{NMInjArg2}
\newrulecommand{MMInjTag}{MMInjTag}
\newrulecommand{MMInjArg}{MMInjArg}
\newrulecommand{TMMTagOne}{TMMTag1}
\newrulecommand{TMMTagTwo}{TMMTag2}
...
\newrulecommand{CTNotInj}{CTNotInj}
\newrulecommand{RXInj}{RXInj}
\newrulecommand{RXNotInj}{RXNotInj}
\newrulecommand{CSInj}{CSInj}
\newrulecommand{CSNotInj}{CSNotInj}
\newrulecommand{CMSInj}{CMSInj}
\newrulecommand{CMSNotInj}{CMSNotInj}

% labeled sum incon
\newrulecommand{CINCInjType}{CINCInjType}
\newrulecommand{CINCInjTag}{CINCInjTag}
\newrulecommand{CINCInjOne}{CINCInj1}
\newrulecommand{CINCInjTwo}{CINCInj2}
\newrulecommand{CINCInjNot}{CINCInjNot}
\newrulecommand{CINCNotInj}{CINCNotInj}

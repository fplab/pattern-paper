...
\begin{proof}
      ...
      \begin{byCases}
        ...
        \begin{byCases}
          ...
          \begin{byCases}
            ...
            \item if $\inValues{e_2'}{\hsnd{e}}$ then $\cnotsatisfyormay{e_2'}{\hxi_2}$ \BY{IH on \pfref{[pair]sndindet} and \pfref{[pair]sndtyp} and \pfref{[pair]c2typ} and \pfref{[pair]not-satormay2}} \pflabel{[pair]complete2}
            \end{pfsteps*} 
            ...
            \begin{byCases}
              ...
              \begin{byCases}
                ...
                By rule induction over \rulesref{rules:TExp} on \pfref{e'typ'}, only one rule applies. \\
                  ...
                  \item $\inValues{e_2'}{\hsnd{e}}$ \BY{\ruleref{rule:IVIndet} on \pfref{[pair]sndnotintro} and \pfref{[pair]sndtyp} and \pfref{e2'val} and \pfref{e2'typ}} \pflabel{e2'invalues}
          ...
          \item if $\inValues{e_1'}{\hfst{e}}$ then $\cnotsatisfyormay{e_1'}{\hxi_1}$ \BY{IH on \pfref{[pair]fstindet} and \pfref{[pair]fsttyp} and \pfref{[pair]c1typ} and \pfref{[pair]not-satormay1}} \pflabel{[pair]complete1}
          \end{pfsteps*} 
          To show if $\inValues{e'}{e}$ then $\cnotsatisfyormay{e'}{\cpair{\hxi_1}{\hxi_2}}$, we assume $\inValues{e'}{e}$.
          \begin{pfsteps*}
          \item $\inValues{e'}{e}$ \BY{assumption} \pflabel{e'invalues}
          ...
          \begin{byCases}
            ...
            \begin{byCases}
              ...
              \begin{byCases}
                ...
                \item $\inValues{e_1'}{\hfst{e}}$ \BY{\ruleref{rule:IVIndet} on \pfref{[pair]fstnotintro} and \pfref{[pair]fsttyp} and \pfref{e1'val} and \pfref{e1'typ}} \pflabel{e1'invalues}
  ...
  \item[\text{(\ref{rule:CSMSSat})}]
    ...
    \item \hexptyp{\cdot}{\Delta}{\hsnd{e}}{\tau_2} \BY{\ruleref{rule:TSnd} on
      ...
      \item \inValues{e_1'}{\hfst{e}} \text{ for fresh $e_1'$} \BY{IH on \pfref{[notintro]c1typ},
      ...
      \item \inValues{e_2'}{\hsnd{e}} \text{ for fresh $e_2'$} \BY{IH on \pfref{[notintro]c2typ},

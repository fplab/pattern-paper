...
\begin{corollary}[Material Entailment of Complete Constraint]
...
\begin{proof}
  ...
  \item \inValues{e'}{\Delta}{e} \text{ implies } \cnotsatisfyormay{e'}{\hxi} \BY{\autoref{lem:complete-not-satormay} on \pfref{1} and \pfref{2} and \pfref{3} and \pfref{4}} \pflabel{notsat}
  \item \inValues{e'}{\Delta}{e} \BY{\autoref{lem:invalues-derivable} on \pfref{2}} \pflabel{invalues}

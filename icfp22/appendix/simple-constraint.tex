...
\begin{proof}
  ...
  \begin{enumerate}
    \item Soundness:
    \begin{pfsteps}
    \item \refutable{\hxi} \BY{assumption} \pflabel{refutable}
    \end{pfsteps}
    By rule induction over \rulesref{rules:xi-refutable} on \pfref{refutable}.
    \begin{byCases}
      \savelocalsteps{0}
      \item[\text{(\ref{rule:RXNum})}] 
      \begin{pfsteps}
      \item \hxi = \cnum{n} \BY{assumption}
      \item \frefutable{\cnum{n}} = \true \BY{\autoref{defn:xi-refutable}}
      \end{pfsteps} 
      \restorelocalsteps{0}
      \item[\text{(\ref{rule:RXUnknown})}] 
      \begin{pfsteps}
      \item \hxi = \cunknown \BY{assumption}
      \item \frefutable{\cunknown} = \true \BY{\autoref{defn:xi-refutable}}
      \end{pfsteps} 
      \restorelocalsteps{0}
      \item[\text{(\ref{rule:RXInl})}] 
      \begin{pfsteps}
      \item \hxi = \cinl{\hxi_1} \BY{assumption}
      \item \frefutable{\cinl{\hxi_1}} = \true \BY{\autoref{defn:xi-refutable}}
      \end{pfsteps} 
      \restorelocalsteps{0}
      \item[\text{(\ref{rule:RXInr})}] 
      \begin{pfsteps}
      \item \hxi = \cinr{\hxi_2} \BY{assumption}
      \item \frefutable{\cinr{\hxi_2}} = \true \BY{\autoref{defn:xi-refutable}}
      \end{pfsteps} 
      \restorelocalsteps{0}
      \item[\text{(\ref{rule:RXPairL})}] 
      \begin{pfsteps}
      \item \hxi = \cpair{\hxi_1}{\hxi_2} \BY{assumption}
      \item \refutable{\hxi_1} \BY{assumption} \pflabel{[pair]1}
      \item \frefutable{\hxi_1} = \true \BY{IH on \pfref{[pair]1}} \pflabel{[pair]f1}
      \item \frefutable{\cpair{\hxi_1}{\hxi_2}} = \true \BY{\autoref{defn:xi-refutable} on \pfref{[pair]f1}}
      \end{pfsteps} 
      \restorelocalsteps{0}
      \item[\text{(\ref{rule:RXPairR})}] 
      \begin{pfsteps}
      \item \hxi = \cpair{\hxi_1}{\hxi_2} \BY{assumption}
      \item \refutable{\hxi_2} \BY{assumption} \pflabel{[pair]2}
      \item \frefutable{\hxi_2} = \true \BY{IH on \pfref{[pair]2}} \pflabel{[pair]f2}
      \item \frefutable{\cpair{\hxi_1}{\hxi_2}} = \true \BY{\autoref{defn:xi-refutable} on \pfref{[pair]f2}}
      \end{pfsteps} 
      \restorelocalsteps{0}
      \item[\text{(\ref{rule:RXOr})}] 
      \begin{pfsteps}
      \item \hxi = \cor{\hxi_1}{\hxi_2} \BY{assumption}
      \item \refutable{\hxi_1} \BY{assumption} \pflabel{[or]1}
      \item \refutable{\hxi_2} \BY{assumption} \pflabel{[or]2}
      \item \frefutable{\hxi_1} = \true \BY{IH on \pfref{[or]1}} \pflabel{[or]f1}
      \item \frefutable{\hxi_2} = \true \BY{IH on \pfref{[or]2}} \pflabel{[or]f2}
      \item \frefutable{\cor{\hxi_1}{\hxi_2}} = \true \BY{\autoref{defn:xi-refutable} on \pfref{[or]f1} and \pfref{[or]f2}}
      \end{pfsteps} 
    \end{byCases}
    \resetpfcounter
    \item Completeness:
    \begin{pfsteps}
    \item \frefutable{\hxi} = \true \BY{assumption} \pflabel{frefutable}
    \end{pfsteps}
    ...
    \begin{byCases}
      ...
      \item[\ctruth]
      \begin{pfsteps}
      \item \frefutable{\ctruth} = \false \BY{\autoref{defn:xi-refutable}}
      \end{pfsteps} 
      Contradicts \pfref{frefutable}.
      \restorelocalsteps{0}
      \item[\cunknown]
      \begin{pfsteps}
      \item \refutable{\cunknown} \BY{\ruleref{rule:RXUnknown}}
      \end{pfsteps} 
      \restorelocalsteps{0}
      \item[\cnum{n}]
      \begin{pfsteps}
      \item \refutable{\cnum{n}} \BY{\ruleref{rule:RXNum}}
      \end{pfsteps} 
      \restorelocalsteps{0}
      \item[\cinl{\hxi_1}]
      \begin{pfsteps}
      \item \refutable{\cinl{\hxi_1}} \BY{\ruleref{rule:RXInl}}
      \end{pfsteps} 
      \restorelocalsteps{0}
      \item[\cinr{\hxi_2}]
      \begin{pfsteps}
      \item \refutable{\cinr{\hxi_2}} \BY{\ruleref{rule:RXInr}}
      \end{pfsteps} 
      \restorelocalsteps{0}
      \item[\cpair{\hxi_1}{\hxi_2}]
      \begin{pfsteps}
      \item \frefutable{\hxi_1} =\true \textor \frefutable{\hxi_2} = \true \BY{\autoref{defn:xi-refutable} on \pfref{frefutable}} \pflabel{[pair]disjunction}
      \end{pfsteps} 
      By case analysis on \pfref{[pair]disjunction}.
      \begin{byCases}
      \savelocalsteps{1}
      \item[\frefutable{\hxi_1}=\true]
      \begin{pfsteps}
      \item \frefutable{\hxi_1}=\true \BY{assumption} \pflabel{[pair]f1}
      \item \refutable{\hxi_1} \BY{IH on \pfref{[pair]f1}} \pflabel{[pair]1}
      \item \refutable{\cpair{\hxi_1}{\hxi_2}} \BY{\ruleref{rule:RXPairL} on \pfref{[pair]1}}
      \end{pfsteps} 
      \restorelocalsteps{1}
      \item[\frefutable{\hxi_2}=\true]
      \begin{pfsteps}
      \item \frefutable{\hxi_2}=\true \BY{assumption} \pflabel{[pair]f2}
      \item \refutable{\hxi_2} \BY{IH on \pfref{[pair]f2}} \pflabel{[pair]2}
      \item \refutable{\cpair{\hxi_1}{\hxi_2}} \BY{\ruleref{rule:RXPairR} on \pfref{[pair]2}}
      \end{pfsteps} 
      \end{byCases}
      \restorelocalsteps{0}
      \item[\cor{\hxi_1}{\hxi_2}]
      \begin{pfsteps}
      \item \frefutable{\hxi_1}=\true \BY{\autoref{defn:xi-refutable} on \pfref{frefutable}} \pflabel{[or]f1}
      \item \frefutable{\hxi_2}=\true \BY{\autoref{defn:xi-refutable} on \pfref{frefutable}} \pflabel{[or]f2}
      \item \refutable{\hxi_1} \BY{IH on \pfref{[or]f1}} \pflabel{[or]1}
      \item \refutable{\hxi_2} \BY{IH on \pfref{[or]f2}} \pflabel{[or]2}
      \item \refutable{\cor{\hxi_1}{\hxi_2}} \BY{\ruleref{rule:RXOr} on \pfref{[or]1} and \pfref{[or]2}}
      \end{pfsteps} 
    \end{byCases}
    \resetpfcounter
  \end{enumerate}
  ...
  \begin{enumerate}
    \item Soundness:
      ...
      \item[\text{(\ref{rule:CSNotIntroPair})}]
        ...
        \item $\csatisfy{\hfst{e}}{\hxi_1}$ \BY{assumption} \pflabel{[notintro]csatisfy1}
        \item $\csatisfy{\hsnd{e}}{\hxi_2}$ \BY{assumption} \pflabel{[notintro]csatisfy2}
        \item $\fsatisfy{\hfst{e}}{\hxi_1} = \true$ \BY{IH on \pfref{[notintro]csatisfy1}} \pflabel{[notintro]fsatisfy1}
        \item $\fsatisfy{\hsnd{e}}{\hxi_2} = \true$ \BY{IH on \pfref{[notintro]csatisfy2}} \pflabel{[notintro]fsatisfy2}
        \end{pfsteps*}
        ...
        \item
          ...
          \item $\fsatisfy{e}{\cpair{\hxi_1}{\hxi_2}} = \fsatisfy{\hfst{e}}{\hxi_1} \text{ and } \fsatisfy{\hsnd{e}}{\hxi_2} = \true$ \BY{Definition \ref{defn:satisfy} on \pfref{[notintro]fsatisfy1} and \pfref{[notintro]fsatisfy2}}
          \end{pfsteps*}
        \end{byCases}
      \end{byCases}
      ...
      \item[\hxi=\cpair{\hxi_1}{\hxi_2}]\ \\
        ...
        \begin{byCases}
          ...
          \item[e=\hehole{u},\hhole{e_0}{u},\hap{e_1}{e_2},\hfst{e_0},\hsnd{e_0},\hmatch{e_0}{\zrules}]
            \begin{pfsteps*}
            \item $\fsatisfy{\hfst{e}}{\hxi_1} = \true$ \BY{Definition \ref{defn:pair-satisfy-pair} on \pfref{fsatisfy}} \pflabel{[notintro]fsatisfy1}
            \item $\fsatisfy{\hsnd{e}}{\hxi_2} = \true$ \BY{Definition \ref{defn:pair-satisfy-pair} on \pfref{fsatisfy}} \pflabel{[notintro]fsatisfy2}
            \item $\csatisfy{\hfst{e}}{\hxi_1}$ \BY{IH on \pfref{[notintro]fsatisfy1}} \pflabel{[notintro]csatisfy1}
            \item $\csatisfy{\hsnd{e}}{\hxi_2}$ \BY{IH on \pfref{[notintro]fsatisfy2}} \pflabel{[notintro]csatisfy2}
...
\begin{proof}
  ...
  \begin{enumerate}
    ...
    \begin{byCases}
      ...
      \begin{pfsteps*}
      \item $\hxi = \cunknown$ \BY{assumption}
      \item $\fmaysatisfy{e}{\cunknown}=\true$ \BY{\autoref{defn:maysat-unknown}}
      \end{pfsteps*} 
      \restorelocalsteps{0}
      ...
      \item $e = \hinl{\tau_2}{e_1}$ \BY{assumption}
      \item $\hxi = \cinl{\hxi_1}$ \BY{assumption}
      \item $\cmaysatisfy{e_1}{\hxi_1}$ \BY{assumption} \pflabel{[inl]maysat1}
      \item $\fmaysatisfy{e_1}{\hxi_1}=\true$ \BY{IH on \pfref{[inl]maysat1}} \pflabel{[inl]fmaysat1}
      \item $\fmaysatisfy{\hinl{\tau_2}{e_1}}{\cinl{\hxi_1}}=\true$ \BY{\autoref{defn:maysat-inl} on \pfref{[inl]fmaysat1}}
      \end{pfsteps*}
      \restorelocalsteps{0}
      ...
      \item $e = \hinr{\tau_1}{e_2}$ \BY{assumption}
      \item $\hxi = \cinr{\hxi_2}$ \BY{assumption}
      \item $\cmaysatisfy{e_2}{\hxi_2}$ \BY{assumption} \pflabel{[inr]maysat2}
      \item $\fmaysatisfy{e_2}{\hxi_2}=\true$ \BY{IH on \pfref{[inr]maysat2}} \pflabel{[inr]fmaysat2}
      \item $\fmaysatisfy{\hinr{\tau_1}{e_2}}{\cinr{\hxi_2}}=\true$ \BY{\autoref{defn:maysat-inr} on \pfref{[inr]fmaysat2}}
      \end{pfsteps*}
      \restorelocalsteps{0}
      ...
      \item $\fmaysatisfy{e_1}{\hxi_1}=\true$ \BY{IH on \pfref{[pair1]maysat1}} \pflabel{[pair1]fmaysat1}
      \item $\fsatisfy{e_2}{\hxi_2}=\true$ \BY{\autoref{lem:sound-complete-satisfy} on \pfref{[pair1]satisfy2}} \pflabel{[pair1]fsatisfy2}
      \item $\fmaysatisfy{\hpair{\hxi_1}{\hxi_2}}{\cpair{\hxi_1}{\hxi_2}}=\true$ \BY{\autoref{defn:maysat-pair} on \pfref{[pair1]fmaysat1} and \pfref{[pair1]fsatisfy2}}
      \end{pfsteps*}
      \restorelocalsteps{0}
      ...
      \item $\fsatisfy{e_1}{\hxi_1}=\true$ \BY{\autoref{lem:sound-complete-satisfy} on \pfref{[pair2]satisfy1}} \pflabel{[pair2]fsatisfy1}
      \item $\fmaysatisfy{e_2}{\hxi_2}=\true$ \BY{IH on \pfref{[pair2]maysat2}} \pflabel{[pair2]fmaysat2}
      \item $\fmaysatisfy{\hpair{\hxi_1}{\hxi_2}}{\cpair{\hxi_1}{\hxi_2}}=\true$ \BY{\autoref{defn:maysat-pair} on \pfref{[pair2]fsatisfy1} and \pfref{[pair2]fmaysat2}}
      \end{pfsteps*}
      \restorelocalsteps{0}
      ...
      \item $\fmaysatisfy{e_1}{\hxi_1}=\true$ \BY{IH on \pfref{[pair3]maysat1}} \pflabel{[pair3]fmaysat1}
      \item $\fmaysatisfy{e_2}{\hxi_2}=\true$ \BY{IH on \pfref{[pair3]maysat2}} \pflabel{[pair3]fmaysat2}
      \item $\fmaysatisfy{\hpair{\hxi_1}{\hxi_2}}{\cpair{\hxi_1}{\hxi_2}}=\true$ \BY{\autoref{defn:maysat-pair} on \pfref{[pair3]fmaysat1} and \pfref{[pair3]fmaysat2}}
      \end{pfsteps*}
      \restorelocalsteps{0}
      \item[\text{(\ref{rule:CMSOr1})}]
      \begin{pfsteps*}
      \item $\hxi = \cor{\hxi_1}{\hxi_2}$ \BY{assumption}
      \item $\cmaysatisfy{e}{\hxi_1}$ \BY{assumption} \pflabel{[or1]maysat1}
      \item $\cnotsatisfy{e}{\hxi_2}$ \BY{assumption} \pflabel{[or1]notsat2}
      \item $\fmaysatisfy{e}{\hxi_1}=\true$ \BY{IH on \pfref{[or1]maysat1}} \pflabel{[or1]fmaysat1}
      \item $\fsatisfy{e}{\hxi_2}=\false$ \BY{\autoref{lem:sound-complete-satisfy} on \pfref{[or1]notsat2}} \pflabel{[or1]fnotsat2}
      \item $\fmaysatisfy{e}{\cor{\hxi_1}{\hxi_2}}=\true$ \BY{\autoref{defn:satisfy-or} on \pfref{[or1]fmaysat1} and \pfref{[or1]fnotsat2}}
      \end{pfsteps*} 
      \restorelocalsteps{0}
      \item[\text{(\ref{rule:CMSOr2})}]
      \begin{pfsteps*}
      \item $\hxi = \cor{\hxi_1}{\hxi_2}$ \BY{assumption}
      \item $\cnotsatisfy{e}{\hxi_1}$ \BY{assumption} \pflabel{[or2]notsat1}
      \item $\cmaysatisfy{e}{\hxi_2}$ \BY{assumption} \pflabel{[or2]maysat2}
      \item $\fsatisfy{e}{\hxi_1}=\false$ \BY{\autoref{lem:sound-complete-satisfy} on \pfref{[or2]notsat1}} \pflabel{[or2]fnotsat1}
      \item $\fmaysatisfy{e}{\hxi_2}=\true$ \BY{IH on \pfref{[or2]maysat2}} \pflabel{[or2]fmaysat2}
      \item $\fmaysatisfy{e}{\cor{\hxi_1}{\hxi_2}}=\true$ \BY{\autoref{defn:satisfy-or} on \pfref{[or2]fnotsat1} and \pfref{[or2]fmaysat2}}
      \end{pfsteps*} 
      \restorelocalsteps{0}
      ...
      \item $\refutable{\hxi}$ \BY{assumption} \pflabel{refutable}
      \item $\fnotIntro{e}=\true$ \BY{\autoref{lem:sound-complete-notintro} on \pfref{notintro}} \pflabel{fnotintro}
      \item $\frefutable{\hxi}=\true$ \BY{\autoref{lem:sound-complete-xi-refutable} on \pfref{refutable}} \pflabel{frefutable}
      \item $\fmaysatisfy{e}{\hxi}=\true$ \BY{\autoref{defn:notintro-maysat-refutable} on \pfref{fnotintro} and \pfref{frefutable}}
      \end{pfsteps*} 
    \end{byCases}
    ...
    \item Completeness:
    \begin{pfsteps*}
    \item $\fmaysatisfy{e}{\hxi}=\true$ \BY{assumption} \pflabel{fmaysat}
    \end{pfsteps*}
    By structural induction on $\hxi$.
    \begin{byCases}
      \savelocalsteps{0}
      \item[\hxi=\ctruth, \cfalsity]
      \begin{pfsteps*}
      \item $\frefutable{\hxi}=\false$ \BY{\autoref{defn:xi-refutable}} \pflabel{[tf]fnotrefutable}
      \item $\fmaysatisfy{e}{\hxi}=\false$ \BY{\autoref{defn:notintro-maysat-refutable} and \pfref{[tf]fnotrefutable}}
      \end{pfsteps*} 
      Contradicts \pfref{fmaysat} and thus vacuously true.
      \restorelocalsteps{0} 
      \item[\hxi=\cunknown]
      \begin{pfsteps*}
      \item $\cmaysatisfy{e}{\cunknown}$ \BY{\ruleref{rule:CMSUnknown}}
      \end{pfsteps*} 
      \restorelocalsteps{0} 
      \item[\hxi=\cnum{n}]
      \begin{pfsteps*}
      \item $\fnotIntro{e}=\true$ \BY{\autoref{defn:notintro-maysat-refutable} of \pfref{fmaysat}} \pflabel{[num]fnotintro}
      \item $\notIntro{e}$ \BY{\autoref{lem:sound-complete-notintro} on \pfref{[num]fnotintro}} \pflabel{[num]notintro}
      \item $\refutable{\cnum{n}}$ \BY{\ruleref{rule:RXNum}} \pflabel{[num]refutable}
      \item $\cmaysatisfy{e}{\cnum{n}}$ \BY{\ruleref{rule:CMSNotIntro} on \pfref{[num]notintro} and \pfref{[num]refutable}}
      \end{pfsteps*} 
      \restorelocalsteps{0} 
      \item[\hxi=\cor{\hxi_1}{\hxi_2}]\mbox{}\\
      By case analysis on \autoref{defn:maysat-or} of \pfref{fmaysat}.
      \begin{byCases}
        \savelocalsteps{1}
        \item[\fmaysatisfy{e}{\hxi_1}=\true\textand\fsatisfy{e}{\hxi_2}=\false]
        \begin{pfsteps*}
        \item $\fmaysatisfy{e}{\hxi_1}=\true$ \BY{assumption} \pflabel{[or]fmaysat1}
        \item $\fsatisfy{e}{\hxi_2}=\false$ \BY{assumption} \pflabel{[or]fnotsatisfy2}
        \item $\cmaysatisfy{e}{\hxi_1}$ \BY{IH on \pfref{[or]fmaysat1}} \pflabel{[or]maysat1}
        \item $\cnotsatisfy{e}{\hxi_2}$ \BY{\autoref{lem:sound-complete-satisfy} on \pfref{[or]fnotsatisfy2}} \pflabel{[or]notsatisfy2}
        \item $\cmaysatisfy{e}{\cor{\hxi_1}{\hxi_2}}$ \BY{\ruleref{rule:CMSOr1} on \pfref{[or]maysat1} and \pfref{[or]notsatisfy2}}
        \end{pfsteps*} 
        \restorelocalsteps{1} 
        \item[\fsatisfy{e}{\hxi_1}=\false\textand\fmaysatisfy{e}{\hxi_2}=\true]
        \begin{pfsteps*}
        \item $\fsatisfy{e}{\hxi_1}=\false$ \BY{assumption} \pflabel{[or]fnotsatisfy1}
        \item $\fmaysatisfy{e}{\hxi_2}=\true$ \BY{assumption} \pflabel{[or]fmaysat2}
        \item $\cnotsatisfy{e}{\hxi_1}$ \BY{\autoref{lem:sound-complete-satisfy} on \pfref{[or]fnotsatisfy1}} \pflabel{[or]notsatisfy1}
        \item $\cmaysatisfy{e}{\hxi_2}$ \BY{IH on \pfref{[or]fmaysat2}} \pflabel{[or]maysat2}
        \item $\cmaysatisfy{e}{\cor{\hxi_1}{\hxi_2}}$ \BY{\ruleref{rule:CMSOr2} on \pfref{[or]notsatisfy1} and \pfref{[or]maysat2}}
        \end{pfsteps*} 
      \end{byCases}
      \restorelocalsteps{0}
      \item[\hxi=\cinl{\hxi_1}]\mbox{}\\
      By structural induction on $e$.
      \begin{byCases}
        \savelocalsteps{1}
        \item[e=\hehole{u},\hhole{e'}{u},\hap{e_1}{e_2},\hmatch{e'}{\zrules},\hfst{e'},\hsnd{e'}]
        \begin{pfsteps*}
        \item $\frefutable{\cinl{\hxi_1}}=\true$ \BY{\autoref{defn:notintro-maysat-refutable} of \pfref{fmaysat}} \pflabel{[inl-notintro]frefutable}
        \item $\refutable{\cinl{\hxi_1}}$ \BY{\autoref{lem:sound-complete-xi-refutable} on \pfref{[inl-notintro]frefutable}} \pflabel{[inl-notintro]refutable}
        \item $\notIntro{e}$ \BY{\rulesref{rules:notintro}} \pflabel{[inl-notintro]notintro}
        \item $\cmaysatisfy{e}{\cinl{\hxi_1}}$ \BY{\ruleref{rule:CMSNotIntro} on \pfref{[inl-notintro]notintro} and \pfref{[inl-notintro]refutable}}
        \end{pfsteps*} 
        \restorelocalsteps{1}
        \item[e=x,\hnum{n},\hlam{x}{\tau}{e'},\hpair{e_1}{e_2}]
        \begin{pfsteps*}
        \item $\fnotIntro{e}=\false$ \BY{\rulesref{rules:notintro}} \pflabel{[inl-intro]fnotnotintro}
        \item $\fmaysatisfy{e}{\cinl{\hxi_1}}=\false$ \BY{\autoref{defn:notintro-maysat-refutable} on \pfref{[inl-intro]fnotnotintro}}
        \end{pfsteps*} 
        Contradicts \pfref{fmaysat}.
        \restorelocalsteps{1}
        \item[e=\hinl{\tau_2}{e_1}]
        \begin{pfsteps*}
        \item $\fmaysatisfy{e_1}{\hxi_1}$ \BY{\autoref{defn:maysat-inl} of \pfref{fmaysat}} \pflabel{[inl]fmaysat1}
        \item $\cmaysatisfy{e_1}{\hxi_1}$ \BY{\autoref{lem:sound-complete-maysatisfy} on \pfref{[inl]fmaysat1}} \pflabel{[inl]maysat1}
        \item $\cmaysatisfy{\hinl{\tau_2}{e_1}}{\cinl{\hxi_1}}$ \BY{\ruleref{rule:CMSInl} on \pfref{[inl]maysat1}}
        \end{pfsteps*} 
        \restorelocalsteps{1}
        \item[e=\hinr{\tau_1}{e_2}] 
        \begin{pfsteps*}
        \item $\fmaysatisfy{\hinr{\tau_1}{e_2}}{\cinl{\hxi_1}}=\false$ \BY{\autoref{defn:not-inr-maysat-inl}}
        \end{pfsteps*} 
        Contradicts \pfref{fmaysat}.
      \end{byCases}
      \restorelocalsteps{0}
      \item[\hxi=\cinr{\hxi_2}]\mbox{}\\
      By structural induction on $e$.
      \begin{byCases}
        \savelocalsteps{1}
        \item[e=\hehole{u},\hhole{e'}{u},\hap{e_1}{e_2},\hmatch{e'}{\zrules},\hfst{e'},\hsnd{e'}]
        \begin{pfsteps*}
        \item $\frefutable{\cinr{\hxi_2}}=\true$ \BY{\autoref{defn:notintro-maysat-refutable} of \pfref{fmaysat}} \pflabel{[inr-notintro]frefutable}
        \item $\refutable{\cinr{\hxi_2}}$ \BY{\autoref{lem:sound-complete-xi-refutable} on \pfref{[inr-notintro]frefutable}} \pflabel{[inr-notintro]refutable}
        \item $\notIntro{e}$ \BY{\rulesref{rules:notintro}} \pflabel{[inr-notintro]notintro}
        \item $\cmaysatisfy{e}{\cinr{\hxi_2}}$ \BY{\ruleref{rule:CMSNotIntro} on \pfref{[inr-notintro]notintro} and \pfref{[inr-notintro]refutable}}
        \end{pfsteps*} 
        \restorelocalsteps{1}
        \item[e=x,\hnum{n},\hlam{x}{\tau}{e'},\hpair{e_1}{e_2}]
        \begin{pfsteps*}
        \item $\fnotIntro{e}=\false$ \BY{\rulesref{rules:notintro}} \pflabel{[inr-intro]fnotnotintro}
        \item $\fmaysatisfy{e}{\cinr{\hxi_2}}=\false$ \BY{\autoref{defn:notintro-maysat-refutable} on \pfref{[inr-intro]fnotnotintro}}
        \end{pfsteps*} 
        Contradicts \pfref{fmaysat}.
        \restorelocalsteps{1}
        \item[e=\hinl{\tau_2}{e_1}]
        \begin{pfsteps*}
        \item $\fmaysatisfy{\hinl{\tau_2}{e_1}}{\cinr{\hxi_2}}=\false$ \BY{\autoref{defn:not-inl-maysat-inr}}
        \end{pfsteps*} 
        Contradicts \pfref{fmaysat}.
        \restorelocalsteps{1}
        \item[e=\hinr{\tau_1}{e_2}] 
        \begin{pfsteps*}
        \item $\fmaysatisfy{e_2}{\hxi_2}$ \BY{\autoref{defn:maysat-inr} of \pfref{fmaysat}} \pflabel{[inr]fmaysat2}
        \item $\cmaysatisfy{e_2}{\hxi_2}$ \BY{\autoref{lem:sound-complete-maysatisfy} on \pfref{[inr]fmaysat2}} \pflabel{[inr]maysat2}
        \item $\cmaysatisfy{\hinr{\tau_1}{e_2}}{\cinr{\hxi_2}}$ \BY{\ruleref{rule:CMSInr} on \pfref{[inr]maysat2}}
        \end{pfsteps*} 
      \end{byCases}
      \restorelocalsteps{0} 
      \item[\hxi=\cpair{\hxi_1}{\hxi_2}]\mbox{}\\
      By structural induction on $e$.
      \begin{byCases}
        \savelocalsteps{1}
        \item[e=\hehole{u},\hhole{e'}{u},\hap{e_1}{e_2},\hmatch{e'}{\zrules},\hfst{e'},\hsnd{e'}]
        \begin{pfsteps*}
        \item $\frefutable{\cpair{\hxi_1}{\hxi_2}}=\true$ \BY{\autoref{defn:notintro-maysat-refutable} of \pfref{fmaysat}} \pflabel{[pair]frefutable}
        \item $\refutable{\cpair{\hxi_1}{\hxi_2}}$ \BY{\autoref{lem:sound-complete-xi-refutable} on \pfref{[pair]frefutable}} \pflabel{[pair]refutable}
        \item $\notIntro{e}$ \BY{\rulesref{rules:notintro}} \pflabel{[pair]notintro}
        \item $\cmaysatisfy{e}{\cpair{\hxi_1}{\hxi_2}}$ \BY{\ruleref{rule:CMSNotIntro} on \pfref{[pair]notintro} and \pfref{[pair]refutable}}
        \end{pfsteps*} 
        \restorelocalsteps{1}
        \item[e=x,\hnum{n},\hlam{x}{\tau}{e'},\hinl{\tau_2}{e_1},\hinr{\tau_1}{e_2}]
        \begin{pfsteps*}
        \item $\fnotIntro{e}=\false$ \BY{\rulesref{rules:notintro}} \pflabel{[pair']fnotnotintro}
        \item $\fmaysatisfy{e}{\cpair{\hxi_1}{\hxi_2}}=\false$ \BY{\autoref{defn:notintro-maysat-refutable} on \pfref{[pair']fnotnotintro}}
        \end{pfsteps*} 
        Contradicts \pfref{fmaysat}.
        \restorelocalsteps{1}
        \item[e=\hpair{e_1}{e_2}]
        By case analysis on \autoref{defn:maysat-pair} on \pfref{fmaysat}. 
        \begin{byCases}
          \savelocalsteps{2}
          \item[\fmaysatisfy{e_1}{\hxi_1}=\true\textand\fsatisfy{e_2}{\hxi_2}=\true] 
          \begin{pfsteps*}
          \item $\fmaysatisfy{e_1}{\hxi_1}=\true$ \BY{assumption} \pflabel{[pair1]fmaysat1}
          \item $\fsatisfy{e_2}{\hxi_2}=\true$ \BY{assumption} \pflabel{[pair1]fsatisfy2}
          \item $\cmaysatisfy{e_1}{\hxi_1}$ \BY{IH on \pfref{[pair1]fmaysat1}} \pflabel{[pair1]maysat1}
          \item $\csatisfy{e_2}{\hxi_2}$ \BY{\autoref{lem:sound-complete-satisfy} on \pfref{[pair1]fsatisfy2}} \pflabel{[pair1]satisfy2}
          \item $\cmaysatisfy{\hpair{e_1}{e_2}}{\cpair{\hxi_1}{\hxi_2}}$ \BY{\ruleref{rule:CMSPair1} on \pfref{[pair1]maysat1} and \pfref{[pair1]satisfy2}}
          \end{pfsteps*} 
          \restorelocalsteps{2}
          \item[\fsatisfy{e_1}{\hxi_1}=\true\textand\fmaysatisfy{e_2}{\hxi_2}=\true]
          \begin{pfsteps*}
          \item $\fsatisfy{e_1}{\hxi_1}$ \BY{assumption} \pflabel{[pair2]fsatisfy1}
          \item $\fmaysatisfy{e_2}{\hxi_2}$ \BY{assumption} \pflabel{[pair2]fmaysat2}
          \item $\csatisfy{e_1}{\hxi_1}$ \BY{\autoref{lem:sound-complete-satisfy} on \pfref{[pair2]fsatisfy1}} \pflabel{[pair2]satisfy1}
          \item $\cmaysatisfy{e_2}{\hxi_2}$ \BY{IH on \pfref{[pair2]fmaysat2}} \pflabel{[pair2]maysat2}
          \item $\cmaysatisfy{\hpair{e_1}{e_2}}{\cpair{\hxi_1}{\hxi_2}}$ \BY{\ruleref{rule:CMSPair2} on \pfref{[pair2]satisfy1} and \pfref{[pair2]maysat2}}
          \end{pfsteps*} 
          \restorelocalsteps{2}
          \item[\fmaysatisfy{e_1}{\hxi_1}=\true\textand\fmaysatisfy{e_2}{\hxi_2}=\true]
          \begin{pfsteps*}
          \item $\fmaysatisfy{e_1}{\hxi_1}$ \BY{assumption} \pflabel{[pair3]fmaysat1}
          \item $\fmaysatisfy{e_2}{\hxi_2}$ \BY{assumption} \pflabel{[pair3]fmaysat2}
          \item $\cmaysatisfy{e_1}{\hxi_1}$ \BY{IH on \pfref{[pair3]fmaysat1}} \pflabel{[pair3]maysat1}
          \item $\cmaysatisfy{e_2}{\hxi_2}$ \BY{IH on \pfref{[pair3]fmaysat2}} \pflabel{[pair3]maysat2}
          \item $\cmaysatisfy{\hpair{e_1}{e_2}}{\cpair{\hxi_1}{\hxi_2}}$ \BY{\ruleref{rule:CMSPair3} on \pfref{[pair3]maysat1} and \pfref{[pair3]maysat2}}
          \end{pfsteps*} 
        \end{byCases}  
      \end{byCases} 
    \end{byCases}
...
\begin{proof}
  ...
  \begin{enumerate}
    ...
    \begin{byCases}
      ...
      \begin{pfsteps*}
      \item $\csatisfy{e}{\hxi}$ \BY{assumption} \pflabel{satisfy}
      \item $\fsatisfy{e}{\hxi}=\true$ \BY{\autoref{lem:sound-complete-satisfy} on \pfref{satisfy}} \pflabel{fsatisfy}
      \item $\fsatisfyormay{e}{\hxi}=\true$ \BY{\autoref{defn:satormay} on \pfref{fsatisfy}}
      \end{pfsteps*} 
      \restorelocalsteps{0} 
      \item[\text{(\ref{rule:CSMSMay})}] 
      \begin{pfsteps*}
      \item $\cmaysatisfy{e}{\hxi}$ \BY{assumption} \pflabel{maysat}
      \item $\fmaysatisfy{e}{\hxi}=\true$ \BY{\autoref{lem:sound-complete-maysatisfy} on \pfref{maysat}} \pflabel{fmaysat}
      \item $\fsatisfyormay{e}{\hxi}=\true$ \BY{\autoref{defn:satormay} on \pfref{fmaysat}}
      \end{pfsteps*}
    \end{byCases}
    \resetpfcounter
    \item Completeness:
    \begin{pfsteps*}
    \item $\fsatisfyormay{e}{\hxi}=\true$ \BY{assumption} \pflabel{fsatormay}
    \end{pfsteps*}
    By case analysis on \autoref{defn:satormay} of \pfref{fsatormay}.
    \begin{byCases}
      \savelocalsteps{0}
      \item[\fsatisfy{e}{\hxi}=\true]
      \begin{pfsteps*}
      \item $\fsatisfy{e}{\hxi}=\true$ \BY{assumption} \pflabel{fsatisfy}
      \item $\csatisfy{e}{\hxi}$ \BY{\autoref{lem:sound-complete-satisfy} on \pfref{fsatisfy}} \pflabel{satisfy}
      \item $\csatisfyormay{e}{\hxi}$ \BY{\ruleref{rule:CSMSSat} on \pfref{satisfy}}
      \end{pfsteps*} 
      \restorelocalsteps{0} 
      \item[\fmaysatisfy{e}{\hxi}=\true] 
      \begin{pfsteps*}
      \item $\fmaysatisfy{e}{\hxi}=\true$ \BY{assumption} \pflabel{fmaysat}
      \item $\cmaysatisfy{e}{\hxi}$ \BY{\autoref{lem:sound-complete-maysatisfy} on \pfref{fmaysat}} \pflabel{maysat}
      \item $\csatisfyormay{e}{\hxi}$ \BY{\ruleref{rule:CSMSMay} on \pfref{maysat}}
      \end{pfsteps*} 
    \end{byCases}
    \resetpfcounter
  \end{enumerate}
...
\begin{proof}
  ...
  \end{pfsteps}
  By rule induction over \ref{rules:CTyp} on \pfref{ctyp}.
  \begin{byCases}
    \savelocalsteps{0}
  \item[\text{(\ref{rule:CTTruth})}]
    ...
    \item[\tau=\tnum]
      \begin{pfsteps}
      \item \isVal{\hnum{0}} \BY{\ruleref{rule:VNum}}
      \item \hexptyp{\cdot}{\cdot}{\hnum{0}}{\tnum} \BY{\ruleref{rule:TNum}} 
      \item \csatisfy{\hnum{0}}{\ctruth} \BY{\ruleref{rule:CSTruth}} \pflabel{[truth][num]satisfy}
      \item \csatisfyormay{\hnum{0}}{\ctruth} \BY{\ruleref{rule:CSMSSat} on \pfref{[truth][num]satisfy}}
      \end{pfsteps}
      Therefore, $\hnum{0}$ is such an $e$.
      \restorelocalsteps{1}
    \item[\tau=\tarr{\tau_1}{\tau_2}]
      \begin{pfsteps}
      \item \ctyp{\ctruth}{\tau_2} \BY{\ruleref{rule:CTTruth}} \pflabel{[truth][arr]ctyp2}
      \item \hexptyp{\cdot}{\Delta}{e_2}{\tau_2} \text{ for some }e_2 \BY{IH on \pfref{[truth][arr]ctyp2}} \pflabel{[truth][arr]etyp2}
      \item \isVal{\hlam{x}{\tau_1}{e_2}} \BY{\ruleref{rule:VLam}}
      \item \hexptyp{x : \tau_1}{\Delta}{e_2}{\tau_2} \BY{Weakening?? on
          \pfref{[truth][arr]etyp2}} \pflabel{[truth][arr]etyp2'}
      \item
        \hexptyp{\cdot}{\Delta}{\hlam{x}{\tau_1}{e_2}}{\tarr{\tau_1}{\tau_2}}
        \BY{\ref{rule:TLam} on \pfref{[truth][arr]etyp2'}}
      \item \csatisfy{\hlam{x}{\tau_1}{e_2}}{\ctruth} \BY{\ruleref{rule:CSTruth}} \pflabel{[truth][arr]satisfy}
      \item \csatisfyormay{\hlam{x}{\tau_1}{e_2}}{\ctruth} \BY{\ruleref{rule:CSMSSat} on \pfref{[truth][arr]satisfy}}
      \end{pfsteps}
      Therefore, $\hlam{x}{\tau_1}{e_2}$ is such an $e$.
      \restorelocalsteps{1}
    \item[\tau=\tprod{\tau_1}{\tau_2}]
      \begin{pfsteps}
      \item \ctyp{\ctruth}{\tau_1} \BY{\ruleref{rule:CTTruth}} \pflabel{[truth][prod]ctyp1}
      \item \ctyp{\ctruth}{\tau_2} \BY{\ruleref{rule:CTTruth}} \pflabel{[truth][prod]ctyp2}
      \item \isVal{e_1} \text{ for some }e_1 \BY{IH on \pfref{[truth][prod]ctyp1}} \pflabel{[truth][prod]eval1}
      \item \hexptyp{\cdot}{\Delta}{e_1}{\tau_1} \text{ for some }e_1 \BY{IH on \pfref{[truth][prod]ctyp1}} \pflabel{[truth][prod]etyp1}
      \item \isVal{e_2} \text{ for some }e_2 \BY{IH on \pfref{[truth][prod]ctyp2}} \pflabel{[truth][prod]eval2}
      \item \hexptyp{\cdot}{\Delta}{e_2}{\tau_2} \text{ for some }e_2 \BY{IH on \pfref{[truth][prod]ctyp2}} \pflabel{[truth][prod]etyp2}
      \item \isVal{\hpair{e_1}{e_2}} \BY{\ruleref{rule:VPair} on
          \pfref{[truth][prod]eval1} and \pfref{[truth][prod]eval2}}
      \item \hexptyp{\cdot}{\Delta}{\hpair{e_1}{e_2}}{\tprod{\tau_1}{\tau_2}} \BY{\ruleref{rule:TPair} on
          \pfref{[truth][prod]etyp1} and \pfref{[truth][prod]etyp2}}
      \item \csatisfy{\hpair{e_1}{e_2}}{\ctruth} \BY{\ruleref{rule:CSTruth}} \pflabel{[truth][prod]satisfy}
      \item \csatisfyormay{\hpair{e_1}{e_2}}{\ctruth} \BY{\ruleref{rule:CSMSSat} on \pfref{[truth][prod]satisfy}}
      \end{pfsteps}
      Therefore, $\hpair{e_1}{e_2}$ is such an $e$.
      \restorelocalsteps{1}
    \item[\tau=\tsum{\tau_1}{\tau_2}]
      \begin{pfsteps}
      \item \ctyp{\ctruth}{\tau_1} \BY{\ruleref{rule:CTTruth}} \pflabel{[truth][sum]ctyp1}
      \item \isVal{e_1} \text{ for some }e_1 \BY{IH on \pfref{[truth][sum]ctyp1}} \pflabel{[truth][sum]eval1}
      \item \hexptyp{\cdot}{\Delta}{e_1}{\tau_1} \text{ for some }e_1 \BY{IH on \pfref{[truth][sum]ctyp1}} \pflabel{[truth][sum]etyp1}
      \item \isVal{\hinl{\tau_2}{e_1}} \BY{\ruleref{rule:VInl} on
          \pfref{[truth][sum]eval1}}
      \item \hexptyp{\cdot}{\Delta}{\hinl{\tau_2}{e_1}}{\tsum{\tau_1}{\tau_2}}
        \BY{\ruleref{rule:TInl} on \pfref{[truth][sum]etyp1}}
      \item \csatisfy{\hinl{\tau_2}{e_1}}{\ctruth} \BY{\ruleref{rule:CSTruth}} \pflabel{[truth][sum]satisfy}
      \item \csatisfyormay{\hinl{\tau_2}{e_1}}{\ctruth} \BY{\ruleref{rule:CSMSSat} on \pfref{[truth][sum]satisfy}}
      \end{pfsteps}
...
\begin{lemma}
  ...
  $\cnotsatisfyormay{e}{\hxi_1}$ and $\cnotsatisfyormay{e}{\hxi_2}$ iff $\cnotsatisfyormay{e}{\cor{\hxi_1}{\hxi_2}}$
\end{lemma}
\begin{proof}
  We prove sufficiency and necessity separately.
\begin{enumerate}

\item Sufficiency: to show $\cnotsatisfyormay{e}{\cor{\hxi_1}{\hxi_2}}$, we assume $\csatisfyormay{e}{\cor{\hxi_1}{\hxi_2}}$.
...
\item Necessity:
\begin{pfsteps*}
\item $\cnotsatisfyormay{e}{\cor{\hxi_1}{\hxi_2}}$ \BY{assumption} \pflabel{notsatormay}
\end{pfsteps*}
We show $\cnotsatisfyormay{e}{\hxi_1}$ and $\cnotsatisfyormay{e}{\hxi_2}$ separately.
\begin{enumerate}
  \savelocalsteps{1}
  \item To show $\cnotsatisfyormay{e}{\hxi_1}$, we assume $\csatisfyormay{e}{\hxi_1}$.
  \begin{pfsteps*}
  \item $\csatisfyormay{e}{\hxi_1}$ \BY{assumption} \pflabel{satormay1}
  \item $\csatisfyormay{e}{\cor{\hxi_1}{\hxi_2}}$ \BY{\autoref{lem:satormay-or} on \pfref{satormay1}}
  \end{pfsteps*}
  Contradicts \pfref{notsatormay}.
  \restorelocalsteps{1}
  \item To show $\cnotsatisfyormay{e}{\hxi_2}$, we assume $\csatisfyormay{e}{\hxi_2}$.
  \begin{pfsteps*}
  \item $\csatisfyormay{e}{\hxi_2}$ \BY{assumption} \pflabel{satormay2}
  \item $\csatisfyormay{e}{\cor{\hxi_1}{\hxi_2}}$ \BY{\autoref{lem:satormay-or} on \pfref{satormay2}}
  \end{pfsteps*}
  Contradicts \pfref{notsatormay}.
\end{enumerate}
In conclusion, $\cnotsatisfyormay{e}{\hxi_1}$ and $\cnotsatisfyormay{e}{\hxi_2}$.
\end{enumerate}
\end{proof}
...
\begin{lemma}
  ...
  $\csatisfyormay{e_1}{\hxi_1}$ iff $\csatisfyormay{\hinl{\tau_2}{e_1}}{\cinl{\hxi_1}}$
\end{lemma}
\begin{proof}
We prove sufficiency and necessity separately.
\begin{enumerate}
...
\item Necessity:
  \begin{pfsteps*}
  \item $\csatisfyormay{\hinl{\tau_2}{e_1}}{\cinl{\hxi_1}}$ \BY{assumption} \pflabel{satormay-inl}
  \end{pfsteps*}
  By rule induction over \rulesref{rules:satormay} on \pfref{satormay-inl}.
  \begin{byCases}
    \savelocalsteps{0}
    \item[\text{(\ref{rule:CSMSSat})}]
    \begin{pfsteps*}
    \item $\csatisfy{\hinl{\tau_2}{e_1}}{\cinl{\hxi_1}}$ \BY{assumption} \pflabel{satisfy-inl}
    \end{pfsteps*} 
    By rule induction over \rulesref{rules:Satisfy} on \pfref{satisfy-inl}, only one rule applies.
    \begin{byCases}
      \item[\text{(\ref{rule:CSInl})}]
      \begin{pfsteps*}
      \item $\csatisfy{e_1}{\hxi_1}$ \BY{assumption} \pflabel{satisfy1}
      \item $\csatisfyormay{e_1}{\hxi_1}$ \BY{\ruleref{rule:CSMSSat} on \pfref{satisfy1}}
      \end{pfsteps*} 
    \end{byCases}
    \restorelocalsteps{0} 
    \item[\text{(\ref{rule:CSMSMay})}] 
    \begin{pfsteps*}
    \item $\cmaysatisfy{\hinl{\tau_2}{e_1}}{\cinl{\hxi_1}}$ \BY{assumption} \pflabel{maysat-inl}
    \end{pfsteps*}
    By rule induction over \rulesref{rules:MaySatisfy} on \pfref{maysat-inl}, only two rules apply.
    \begin{byCases}
      \savelocalsteps{1}
      \item[\text{(\ref{rule:CMSInl})}]
      \begin{pfsteps*}
      \item $\cmaysatisfy{e_1}{\hxi_1}$ \BY{assumption} \pflabel{maysat1}
      \item $\csatisfyormay{e_1}{\hxi_1}$ \BY{\ruleref{rule:CSMSMay} on \pfref{maysat1}}
      \end{pfsteps*} 
      \restorelocalsteps{1} 
      \item[\text{(\ref{rule:CMSNotIntro})}] 
      \begin{pfsteps*}
      \item $\notIntro{\hinl{\tau_2}{e_1}}$ \BY{assumption} \pflabel{notintro-inl}
      \end{pfsteps*} 
      By rule induction over \rulesref{rules:notintro} on \pfref{notintro-inl}, no rule applies due to syntactic contradiction.
    \end{byCases}
  \end{byCases}
\resetpfcounter
\end{enumerate}
...
\begin{lemma}
  ...
  $\csatisfyormay{e_2}{\hxi_2}$ iff $\csatisfyormay{\hinr{\tau_1}{e_2}}{\cinr{\hxi_2}}$
\end{lemma}
\begin{proof}
We prove sufficiency and necessity separately.
\begin{enumerate}
...
\item Sufficiency:
  ...
  \item[\text{(\ref{rule:CSMSMay})}]
    ...
    \item $\cmaysatisfy{\hinr{\tau_1}{e_2}}{\cinr{\hxi_2}}$ \BY{Rule (\ref{rule:CMSInr}) on \pfref{maysat2}} \pflabel{maysatInr}
    \item $\csatisfyormay{\hinr{\tau_1}{e_2}}{\cinr{\hxi_2}}$ \BY{Rule (\ref{rule:CSMSMay}) on \pfref{maysatInr}}
    \end{pfsteps*}
  \end{byCases}
\resetpfcounter
...
\item Necessity:
  \begin{pfsteps*}
  \item $\csatisfyormay{\hinr{\tau_1}{e_2}}{\cinr{\hxi_2}}$ \BY{assumption} \pflabel{satormay-inr}
  \end{pfsteps*}
  By rule induction over \rulesref{rules:satormay} on \pfref{satormay-inr}.
  \begin{byCases}
    \savelocalsteps{0}
    \item[\text{(\ref{rule:CSMSSat})}]
    \begin{pfsteps*}
    \item $\csatisfy{\hinr{\tau_1}{e_2}}{\cinr{\hxi_2}}$ \BY{assumption} \pflabel{satisfy-inr}
    \end{pfsteps*} 
    By rule induction over \rulesref{rules:Satisfy} on \pfref{satisfy-inr}, only one rule applies.
    \begin{byCases}
      \item[\text{(\ref{rule:CSInr})}]
      \begin{pfsteps*}
      \item $\csatisfy{e_2}{\hxi_2}$ \BY{assumption} \pflabel{satisfy2}
      \item $\csatisfyormay{e_2}{\hxi_2}$ \BY{\ruleref{rule:CSMSSat} on \pfref{satisfy2}}
      \end{pfsteps*} 
    \end{byCases}
    \restorelocalsteps{0} 
    \item[\text{(\ref{rule:CSMSMay})}] 
    \begin{pfsteps*}
    \item $\cmaysatisfy{\hinr{\tau_1}{e_2}}{\cinr{\hxi_2}}$ \BY{assumption} \pflabel{maysat-inr}
    \end{pfsteps*}
    By rule induction over \rulesref{rules:MaySatisfy} on \pfref{maysat-inr}, only two rules apply.
    \begin{byCases}
      \savelocalsteps{1}
      \item[\text{(\ref{rule:CMSInr})}]
      \begin{pfsteps*}
      \item $\cmaysatisfy{e_2}{\hxi_2}$ \BY{assumption} \pflabel{maysat2}
      \item $\csatisfyormay{e_2}{\hxi_2}$ \BY{\ruleref{rule:CSMSMay} on \pfref{maysat2}}
      \end{pfsteps*} 
      \restorelocalsteps{1} 
      \item[\text{(\ref{rule:CMSNotIntro})}] 
      \begin{pfsteps*}
      \item $\notIntro{\hinr{\tau_1}{e_2}}$ \BY{assumption} \pflabel{notintro-inr}
      \end{pfsteps*} 
      By rule induction over \rulesref{rules:notintro} on \pfref{notintro-inr}, no rule applies due to syntactic contradiction.
    \end{byCases}
  \end{byCases}
  \resetpfcounter
\end{enumerate}
...
\begin{lemma}
  ...
  $\csatisfyormay{e_1}{\hxi_1}$ and $\csatisfyormay{e_2}{\hxi_2}$ iff $\csatisfyormay{\hpair{e_1}{e_2}}{\cpair{\hxi_1}{\hxi_2}}$
\end{lemma}
\begin{proof}
  We prove sufficiency and necessity separately.
  \begin{enumerate}
    ...
    \item $\csatisfyormay{e_2}{\hxi_2}$ \BY{assumption} \pflabel{satormay2}
    \end{pfsteps*}
    By rule induction over \rulesref{rules:satormay} on \pfref{satormay1}.
    \begin{byCases}
      \savelocalsteps{0}
      \item[\text{(\ref{rule:CSMSSat})}]
      \begin{pfsteps*}
      \item $\csatisfy{e_1}{\hxi_1}$ \BY{assumption} \pflabel{satisfy1}
      \end{pfsteps*} 
      By rule induction over \rulesref{rules:satormay} on \pfref{satormay2}.
      \begin{byCases}
        \savelocalsteps{0}
        \item[\text{(\ref{rule:CSMSSat})}] 
        \begin{pfsteps*}
        \item $\csatisfy{e_2}{\hxi_2}$ \BY{assumption} \pflabel{[sat]satisfy2}
        \item $\csatisfy{\hpair{e_1}{e_2}}{\cpair{\hxi_1}{\hxi_2}}$ \BY{\ruleref{rule:CSPair} on \pfref{satisfy1} and \pfref{[sat]satisfy2}} \pflabel{[sat]satisfy}
        \item $\csatisfyormay{\hpair{e_1}{e_2}}{\cpair{\hxi_1}{\hxi_2}}$ \BY{\ruleref{rule:CSMSSat} on \pfref{[sat]satisfy}}
        \end{pfsteps*} 
        \restorelocalsteps{0} 
        \item[\text{(\ref{rule:CSMSMay})}] 
        \begin{pfsteps*}
        \item $\cmaysatisfy{e_2}{\hxi_2}$ \BY{assumption} \pflabel{[sat]maysat2}
        \item $\cmaysatisfy{\hpair{e_1}{e_2}}{\cpair{\hxi_1}{\hxi_2}}$ \BY{\ruleref{rule:CMSPair2} on \pfref{satisfy1} and \pfref{[sat]maysat2}} \pflabel{[sat]maysat}
        \item $\csatisfyormay{\hpair{e_1}{e_2}}{\cpair{\hxi_1}{\hxi_2}}$ \BY{\ruleref{rule:CSMSMay} on \pfref{[sat]maysat}}
        \end{pfsteps*} 
      \end{byCases} 
      \restorelocalsteps{0} 
      \item[\text{(\ref{rule:CSMSMay})}]
      ...
      \begin{byCases}
        ...
        \item[\text{(\ref{rule:CSMSSat})}] 
        \begin{pfsteps*}
        \item $\csatisfy{e_2}{\hxi_2}$ \BY{assumption} \pflabel{[may]satisfy2}
        \item $\cmaysatisfy{\hpair{e_1}{e_2}}{\cpair{\hxi_1}{\hxi_2}}$ \BY{\ruleref{rule:CMSPair1} on \pfref{maysat1} and \pfref{[may]satisfy2}} \pflabel{[may]maysat}
        \item $\csatisfyormay{\hpair{e_1}{e_2}}{\cpair{\hxi_1}{\hxi_2}}$ \BY{\ruleref{rule:CSMSMay} on \pfref{[may]maysat}}
        \end{pfsteps*} 
        \restorelocalsteps{0} 
        \item[\text{(\ref{rule:CSMSMay})}] 
        \begin{pfsteps*}
        \item $\cmaysatisfy{e_2}{\hxi_2}$ \BY{assumption} \pflabel{[may]maysat2}
        \item $\cmaysatisfy{\hpair{e_1}{e_2}}{\cpair{\hxi_1}{\hxi_2}}$ \BY{\ruleref{rule:CMSPair2} on \pfref{maysat1} and \pfref{[may]maysat2}} \pflabel{[may]maysat'}
        \item $\csatisfyormay{\hpair{e_1}{e_2}}{\cpair{\hxi_1}{\hxi_2}}$ \BY{\ruleref{rule:CSMSMay} on \pfref{[may]maysat'}}
        \end{pfsteps*} 
      \end{byCases}  
    \end{byCases}
    ...
    \item Necessity:
    \begin{pfsteps*}
    \item $\csatisfyormay{\hpair{e_1}{e_2}}{\cpair{\hxi_1}{\hxi_2}}$ \BY{assumption} \pflabel{satormay}
    \end{pfsteps*}
    By rule induction over \rulesref{rules:satormay} on \pfref{satormay}.
    \begin{byCases}
      \savelocalsteps{0}
      \item[\text{(\ref{rule:CSMSSat})}]
      \begin{pfsteps*}
      \item $\csatisfy{\hpair{e_1}{e_2}}{\cpair{\hxi_1}{\hxi_2}}$ \BY{assumption} \pflabel{satisfy}
      \end{pfsteps*} 
      By rule induction over \rulesref{rules:Satisfy} on \pfref{satisfy}, only one rule applies.
      \begin{byCases}
        \item[\text{(\ref{rule:CSPair})}]
        \begin{pfsteps*}
        \item $\csatisfy{e_1}{\hxi_1}$ \BY{assumption} \pflabel{1-satisfy1}
        \item $\csatisfy{e_2}{\hxi_2}$ \BY{assumption} \pflabel{1-satisfy2}
        \item $\csatisfyormay{e_1}{\hxi_1}$ \BY{\ruleref{rule:CSMSSat} on \pfref{1-satisfy1}}
        \item $\csatisfyormay{e_2}{\hxi_2}$ \BY{\ruleref{rule:CSMSSat} on \pfref{1-satisfy2}}
        \end{pfsteps*}
      \end{byCases}
      \restorelocalsteps{0}
      \item[\text{(\ref{rule:CSMSMay})}]
      \begin{pfsteps*}
      \item $\cmaysatisfy{\hpair{e_1}{e_2}}{\cpair{\hxi_1}{\hxi_2}}$ \BY{assumption} \pflabel{maysat}
      \end{pfsteps*} 
      By rule induction over \rulesref{rules:MaySatisfy} on \pfref{maysat}, only three rules apply.
      \begin{byCases}
        \savelocalsteps{1}
        \item[\text{(\ref{rule:CMSPair1})}]
        \begin{pfsteps*}
        \item $\cmaysatisfy{e_1}{\hxi_1}$ \BY{assumption} \pflabel{2-maysat1}
        \item $\csatisfy{e_2}{\hxi_2}$ \BY{assumption} \pflabel{2-satisfy2}
        \item $\csatisfyormay{e_1}{\hxi_1}$ \BY{\ruleref{rule:CSMSMay} on \pfref{2-maysat1}}
        \item $\csatisfyormay{e_2}{\hxi_2}$ \BY{\ruleref{rule:CSMSSat} on \pfref{2-satisfy2}}
        \end{pfsteps*} 
        \restorelocalsteps{1} 
        \item[\text{(\ref{rule:CMSPair2})}]
        \begin{pfsteps*}
        \item $\csatisfy{e_1}{\hxi_1}$ \BY{assumption} \pflabel{3-satisfy1}
        \item $\cmaysatisfy{e_2}{\hxi_2}$ \BY{assumption} \pflabel{3-maysat2}
        \item $\csatisfyormay{e_1}{\hxi_1}$ \BY{\ruleref{rule:CSMSSat} on \pfref{3-satisfy1}}
        \item $\csatisfyormay{e_2}{\hxi_2}$ \BY{\ruleref{rule:CSMSMay} on \pfref{3-maysat2}}
        \end{pfsteps*} 
        \restorelocalsteps{1} 
        \item[\text{(\ref{rule:CMSPair3})}] 
        \begin{pfsteps*}
        \item $\cmaysatisfy{e_1}{\hxi_1}$ \BY{assumption} \pflabel{4-maysat1}
        \item $\cmaysatisfy{e_2}{\hxi_2}$ \BY{assumption} \pflabel{4-maysat2}
        \item $\csatisfyormay{e_1}{\hxi_1}$ \BY{\ruleref{rule:CSMSMay} on \pfref{4-maysat1}}
        \item $\csatisfyormay{e_2}{\hxi_2}$ \BY{\ruleref{rule:CSMSMay} on \pfref{4-maysat2}}
        \end{pfsteps*} 
      \end{byCases}
    \end{byCases}
    \resetpfcounter
...
\begin{byCases}
  ...
  \begin{byCases}
    ...
    \item e = \hinl{\tau_2}{e_1} \BY{assumption}
    \end{pfsteps} 
    By rule induction over \rulesref{rules:notintro} on \pfref{notintro}, no rule applies due to syntactic contradiction.
    \restorelocalsteps{1}
    \item[\text{(\ref{rule:CMSInr})}]
    \begin{pfsteps}
    \item e = \hinr{\tau_1}{e_2} \BY{assumption}
    ...
    \item \cmaysatisfy{e}{\hxi_1} \BY{assumption} \pflabel{[or1']maysat1}
    \item \cnotsatisfy{e}{\hxi_2} \BY{assumption} \pflabel{[or1']notsat2}
    \item \refutable{\hxi_1} \BY{IH on \pfref{notintro} and \pfref{[or1']maysat1}} \pflabel{[or1']refutable1}
    \item \refutable{\hxi_2} \BY{IH on \pfref{notintro} and \pfref{[or1']notsat2}} \pflabel{[or1']refutable2}
    \item \refutable{\cor{\hxi_1}{\hxi_2}} \BY{\ruleref{rule:RXOr} on \pfref{[or1']refutable1} and \pfref{[or1']refutable2}}
    \end{pfsteps} 
    \restorelocalsteps{1}
    \item[\text{(\ref{rule:CMSOr2})}]
    \begin{pfsteps}
    ...
    \item \cnotsatisfy{e}{\hxi_1} \BY{assumption} \pflabel{[or2']notsat1}
    \item \cmaysatisfy{e}{\hxi_2} \BY{assumption} \pflabel{[or2']maysat2}
    \item \refutable{\hxi_1} \BY{IH on \pfref{notintro} and \pfref{[or2']notsat1}} \pflabel{[or2']refutable1}
    \item \refutable{\hxi_2} \BY{IH on \pfref{notintro} and \pfref{[or2']maysat2}} \pflabel{[or2']refutable2}
    \item \refutable{\cor{\hxi_1}{\hxi_2}} \BY{\ruleref{rule:RXOr} on \pfref{[or2']refutable1} and \pfref{[or2']refutable2}}
    \end{pfsteps} 
    \restorelocalsteps{1}
    \item[\text{(\ref{rule:CMSNotIntro})}]
    \begin{pfsteps}
    \item \refutable{\hxi} \BY{assumption}
    \end{pfsteps} 
  \end{byCases}
  \restorelocalsteps{0} 
  \item[\cnotsatisfy{e}{\hxi}]
  \begin{pfsteps}
  \item \cnotsatisfy{e}{\hxi} \BY{assumption} \pflabel{notsat}
  \end{pfsteps}  
  By structural induction on $\hxi$.
  \begin{byCases}
    \savelocalsteps{1}
    ...
    \item[\hxi=\cpair{\hxi_1}{\hxi_2}]   
    \begin{pfsteps}
    \item \notIntro{\hfst{e}} \BY{\ruleref{rule:NVFst}} \pflabel{[pair]fst-notintro}
    \item \notIntro{\hsnd{e}} \BY{\ruleref{rule:NVSnd}} \pflabel{[pair]snd-notintro}
    \end{pfsteps}
    ...
    \begin{byCases}
      ...
      \item[\true, \true]
      \begin{pfsteps}
      \item \fsatisfy{\hfst{e}}{\hxi_1} = \true \BY{assumption} \pflabel{[pair1]fst-fsatisfy}
      \item \fsatisfy{\hsnd{e}}{\hxi_2} = \true \BY{assumption} \pflabel{[pair1]snd-fsatisfy}
      \item \csatisfy{\hfst{e}}{\hxi_1} \BY{\autoref{lem:sound-complete-satisfy} on \pfref{[pair1]fst-fsatisfy}} \pflabel{[pair1]fst-satisfy}
      \item \csatisfy{\hsnd{e}}{\hxi_2} \BY{\autoref{lem:sound-complete-satisfy} on \pfref{[pair1]snd-fsatisfy}} \pflabel{[pair1]snd-satisfy}
      \item \csatisfy{e}{\cpair{\hxi_1}{\hxi_2}} \BY{\ruleref{rule:CSNotIntroPair} on \pfref{notintro} and \pfref{[pair1]fst-satisfy} and \pfref{[pair1]snd-satisfy}}
      \end{pfsteps} 
      Contradicts $\cnotsatisfy{e}{\cpair{\hxi_1}{\hxi_2}}$.
      \restorelocalsteps{2} 
      \item[\true, \false]
      \begin{pfsteps}
      \item \fsatisfy{\hfst{e}}{\hxi_1} = \true \BY{assumption} \pflabel{[pair2]fst-fsatisfy}
      \item \fsatisfy{\hsnd{e}}{\hxi_2} = \false \BY{assumption} \pflabel{[pair2]snd-fsatisfy}
      \item \cnotsatisfy{\hsnd{e}}{\hxi_2} \BY{\autoref{lem:sound-complete-satisfy} on \pfref{[pair2]snd-fsatisfy}} \pflabel{[pair2]snd-satisfy}
      \item \refutable{\hxi_2} \BY{IH on \pfref{[pair]snd-notintro} and \pfref{[pair2]snd-satisfy}} \pflabel{[pair2]refutable2}
      \item \refutable{\cpair{\hxi_1}{\hxi_2}} \BY{\ruleref{rule:RXPairR} on \pfref{[pair2]refutable2}}
      \end{pfsteps} 
      \restorelocalsteps{2}
      \item[\false, \true]
      \begin{pfsteps}
      \item \fsatisfy{\hfst{e}}{\hxi_1} = \false \BY{assumption} \pflabel{[pair3]fst-fsatisfy}
      \item \fsatisfy{\hsnd{e}}{\hxi_2} = \true \BY{assumption} \pflabel{[pair3]snd-fsatisfy}
      \item \cnotsatisfy{\hfst{e}}{\hxi_1} \BY{\autoref{lem:sound-complete-satisfy} on \pfref{[pair3]fst-fsatisfy}} \pflabel{[pair3]fst-satisfy}
      \item \refutable{\hxi_1} \BY{IH on \pfref{[pair]fst-notintro} and \pfref{[pair3]fst-satisfy}} \pflabel{[pair3]refutable1}
      \item \refutable{\cpair{\hxi_1}{\hxi_2}} \BY{\ruleref{rule:RXPairL} on \pfref{[pair3]refutable1}}
      \end{pfsteps} 
      \restorelocalsteps{2}
      \item[\false, \false]
      \begin{pfsteps}
      \item \fsatisfy{\hfst{e}}{\hxi_1} = \false \BY{assumption} \pflabel{[pair4]fst-fsatisfy}
      \item \fsatisfy{\hsnd{e}}{\hxi_2} = \false \BY{assumption} \pflabel{[pair4]snd-fsatisfy}
      \item \cnotsatisfy{\hfst{e}}{\hxi_1} \BY{\autoref{lem:sound-complete-satisfy} on \pfref{[pair4]fst-fsatisfy}} \pflabel{[pair4]fst-satisfy}
      \item \refutable{\hxi_1} \BY{IH on \pfref{[pair]fst-notintro} and \pfref{[pair4]fst-satisfy}} \pflabel{[pair4]refutable1}
      \item \refutable{\cpair{\hxi_1}{\hxi_2}} \BY{\ruleref{rule:RXPairL} on \pfref{[pair4]refutable1}}
      \end{pfsteps}    
    \end{byCases}
    \restorelocalsteps{1}
    \item[\hxi=\cor{\hxi_1}{\hxi_2}] \mbox{ }\\
    To show that $\cnotsatisfy{e}{\hxi_1}$, we assume $\csatisfy{e}{\hxi_1}$ and obtain a contradiction.
    \savelocalsteps{2}
    \proofleftskip=3pc
    \begin{pfsteps}
    \item \csatisfy{e}{\hxi_1} \BY{assumption} \pflabel{[or]satisfy1}
    \item \csatisfy{e}{\cor{\hxi_1}{\hxi_2}} \BY{\ruleref{rule:CSOr1} on \pfref{[or]satisfy1}}
    \end{pfsteps}
    \restorelocalsteps{2}
    \proofleftskip=2pc
    Contradicts \pfref{notsat}. Therefore,
    \begin{pfsteps}
    \item \cnotsatisfy{e}{\hxi_1} \BY{contradiction} \pflabel{[or]notsat1}
    \item \refutable{\hxi_1} \BY{IH on \pfref{notintro} and \pfref{[or]notsat1}} \pflabel{[or]refutable1}
    \end{pfsteps}
    Similarly, to show that $\cnotsatisfy{e}{\hxi_2}$, we assume $\csatisfy{e}{\hxi_2}$ and obtain a contradiction.
    \savelocalsteps{2}
    \proofleftskip=3pc
    \begin{pfsteps}
    \item \csatisfy{e}{\hxi_2} \BY{assumption} \pflabel{[or]satisfy2}
    \item \csatisfy{e}{\cor{\hxi_1}{\hxi_2}} \BY{\ruleref{rule:CSOr2} on \pfref{[or]satisfy2}}
    \end{pfsteps}
    \restorelocalsteps{2}
    \proofleftskip=2pc
    Contradicts \pfref{notsat}. Therefore,
    \begin{pfsteps}
    \item \cnotsatisfy{e}{\hxi_2} \BY{contradiction} \pflabel{[or]notsat2}
    \item \refutable{\hxi_2} \BY{IH on \pfref{notintro} and \pfref{[or]notsat2}} \pflabel{[or]refutable2}
    \item \refutable{\cor{\hxi_1}{\hxi_2}} \BY{\ruleref{rule:RXOr} on \pfref{[or]refutable1} and \pfref{[or]refutable2}}
    \end{pfsteps}
  \end{byCases}
\end{byCases}
\end{proof}
...
\item[\text{(\ref{rule:CSTruth})}]
    ...
    \item $\hxi=\ctruth$ \BY{assumption}
    \end{pfsteps*}
    By rule induction over \rulesref{rules:xi-refutable}, no case applies due to syntactic contradiction.
\restorelocalsteps{0}
\item[\text{(\ref{rule:CSOr1})}]
    \begin{pfsteps*}
    \item $\hxi=\cor{\hxi_1}{\hxi_2}$ \BY{assumption}
    \item $\csatisfy{e}{\hxi_1}$ \BY{assumption} \pflabel{or1-satisfy1}
    \item $\cancel{\refutable{\hxi_1}}$ \BY{IH on \pfref{e-notintro} and \pfref{or1-satisfy1}} \pflabel{or1-notrft1}
    \item $\cancel{\refutable{\cor{\hxi_1}{\hxi_2}}}$ \BY{\autoref{lem:no-or-refutable}}
    \end{pfsteps*}
    By rule induction over \rulesref{rules:xi-refutable} on \pfref{refutable}, only one rule applies.
    \begin{byCases}
      \item[\text{(\ref{rule:RXOr})}]
      \begin{pfsteps}
      \item \refutable{\hxi_1} \BY{assumption}
      \end{pfsteps} 
      Contradicts \pfref{or1-notrft1}.
    \end{byCases}
\restorelocalsteps{0}
\item[\text{(\ref{rule:CSOr2})}]
    \begin{pfsteps*}
    ...
    \item $\cancel{\refutable{\hxi_2}}$ \BY{IH on \pfref{e-notintro} and \pfref{or2-satisfy2}} \pflabel{or2-notrft2}
    \item $\cancel{\refutable{\cor{\hxi_1}{\hxi_2}}}$ \BY{\autoref{lem:no-or-refutable}}
    \end{pfsteps*}
    By rule induction over \rulesref{rules:xi-refutable} on \pfref{refutable}, only one rule applies.
    \begin{byCases}
      ...
      \end{pfsteps} 
      Contradicts \pfref{or2-notrft2}.
    \end{byCases}
\restorelocalsteps{0}
\item[\text{(\ref{rule:CSNotIntroPair})}]
    \begin{pfsteps*}
    \item $\hxi=\cpair{\hxi_1}{\hxi_2}$ \BY{assumption}
    \item $\csatisfy{\hfst{e}}{\hxi_1}$ \BY{assumption} \pflabel{fst-satisfy}
    \item $\csatisfy{\hsnd{e}}{\hxi_2}$ \BY{assumption} \pflabel{snd-satisfy}
    \item $\notIntro{\hfst{e}}$ \BY{\ruleref{rule:NVFst}} \pflabel{fst-notintro}
    \item $\notIntro{\hsnd{e}}$ \BY{\ruleref{rule:NVSnd}} \pflabel{snd-notintro}
    \item $\cancel{\refutable{\hxi_1}}$ \BY{IH on \pfref{fst-notintro} and \pfref{fst-satisfy}} \pflabel{not-rft1}
    \item $\cancel{\refutable{\hxi_2}}$ \BY{IH on \pfref{snd-notintro} and \pfref{snd-satisfy}} \pflabel{not-rft2}
    \end{pfsteps*}
    By rule induction over \rulesref{rules:xi-refutable} on it, only two cases apply.
    \begin{byCases}
    \savelocalsteps{1}
    \item[\text{(\ref{rule:RXPairL})}]
        \begin{pfsteps*}
...
\begin{proof}
  ...
  \begin{pfsteps*}
  \item $\csatisfyormay{\hinl{\tau_2}{e_1}}{\cinr{\hxi_2}}$ \BY{assumption} \pflabel{satormay}
  \end{pfsteps*}
  By rule induction over \rulesref{rules:satormay} on \pfref{satormay}.
  \begin{byCases}
    \savelocalsteps{0}
    \item[\text{(\ref{rule:CSMSSat})}]
    \begin{pfsteps*}
    \item $\csatisfy{\hinl{\tau_2}{e_1}}{\cinr{\hxi_2}}$ \BY{assumption} \pflabel{satisfy}
    \end{pfsteps*} 
    By rule induction over \rulesref{rules:Satisfy} on \pfref{satisfy}, no rule applies due to syntactic contradiction.
    \restorelocalsteps{0} 
    \item[\text{(\ref{rule:CSMSMay})}] 
    \begin{pfsteps*}
    \item $\cmaysatisfy{\hinl{\tau_2}{e_1}}{\cinr{\hxi_2}}$ \BY{assumption} \pflabel{maysat}
    \end{pfsteps*} 
    By rule induction over \rulesref{rules:MaySatisfy} on \pfref{maysat}, only one rule applies.
    \begin{byCases}
      \item[\text{(\ref{rule:CMSNotIntro})}]
      \begin{pfsteps*}
      \item $\notIntro{\hinl{\tau_2}{e_1}}$ \BY{assumption} \pflabel{notintro}
      \end{pfsteps*} 
      By rule induction over \rulesref{rules:notintro} on \pfref{notintro}, no rule applies due to syntactic contradiction.
    \end{byCases}
  \end{byCases}
...
\begin{proof}
  ...
  \begin{pfsteps*}
  \item $\csatisfyormay{\hinr{\tau_1}{e_2}}{\cinl{\hxi_1}}$ \BY{assumption} \pflabel{satormay}
  \end{pfsteps*}
  By rule induction over \rulesref{rules:satormay} on \pfref{satormay}.
  \begin{byCases}
    \savelocalsteps{0}
    \item[\text{(\ref{rule:CSMSSat})}]
    \begin{pfsteps*}
    \item $\csatisfy{\hinr{\tau_1}{e_2}}{\cinl{\hxi_1}}$ \BY{assumption} \pflabel{satisfy}
    \end{pfsteps*} 
    By rule induction over \rulesref{rules:Satisfy} on \pfref{satisfy}, no rule applies due to syntactic contradiction.
    \restorelocalsteps{0} 
    \item[\text{(\ref{rule:CSMSMay})}] 
    \begin{pfsteps*}
    \item $\cmaysatisfy{\hinr{\tau_1}{e_2}}{\cinl{\hxi_1}}$ \BY{assumption} \pflabel{maysat}
    \end{pfsteps*} 
    By rule induction over \rulesref{rules:MaySatisfy} on \pfref{maysat}, only one rule applies.
    \begin{byCases}
      \item[\text{(\ref{rule:CMSNotIntro})}]
      \begin{pfsteps*}
      \item $\notIntro{\hinr{\tau_1}{e_2}}$ \BY{assumption} \pflabel{notintro}
      \end{pfsteps*} 
      By rule induction over \rulesref{rules:notintro} on \pfref{notintro}, no rule applies due to syntactic contradiction.
    \end{byCases}
  \end{byCases}
...
\item[\text{(\ref{rule:CTNum})}]
    ...
    \item[\text{(\ref{rule:TNum})}]
        ...
        \item[n_1=n_2]
            ...
            \item $\csatisfyormay{\hnum{n_1}}{\cnum{n_2}}$ \BY{\ruleref{rule:CSMSSat} on \pfref{[num]num-satisfy}} 
            \end{pfsteps*}
        \restorelocalsteps{2}
        \item[n_1\neq n_2]
            \begin{pfsteps*}
            ...
            \item $\cnotsatisfyormay{\hnum{n_1}}{\cnum{n_2}}$ \BY{\autoref{lem:not-satormay} on \pfref{[num]num-notmaysat} and \pfref{[num]num-notsatisfy}} 
            \end{pfsteps*}
        \end{byCases}
    \end{byCases}
...
\item[\text{(\ref{rule:CTOr})}]
    ...
    \item[\csatisfy{e}{\hxi_1},\csatisfy{e}{\hxi_2}]
        ...
        \item[\text{(\ref{rule:CMSNotIntro})}]
            \begin{pfsteps*}
            \item $\notIntro{e}$ \BY{assumption} \pflabel{[or1]notintro}
            \item $\refutable{\cor{\hxi_1}{\hxi_2}}$ \BY{assumption} \pflabel{[or1]rft}
            \item $\cancel{\refutable{\cor{\hxi_1}{\hxi_2}}}$ \BY{\autoref{lem:satisfy-not-refutable} on \pfref{[or1]notintro} and \pfref{[or1]satisfy-or}} \pflabel{[or1]notrft}
            \end{pfsteps*}
            \pfref{[or1]rft} and \pfref{[or1]notrft} are in contradiction with each other.
        \restorelocalsteps{2}
        \item[\text{(\ref{rule:CMSOr1})}]
            \begin{pfsteps*}
    ...
    \item[\csatisfy{e}{\hxi_1},\cmaysatisfy{e}{\hxi_2}]
        ...
        \item[\text{(\ref{rule:CMSNotIntro})}]
            \begin{pfsteps*}
            \item $\notIntro{e}$ \BY{assumption} \pflabel{[or2]notintro}
            \item $\refutable{\cor{\hxi_1}{\hxi_2}}$ \BY{assumption} \pflabel{[or2]rft}
            \item $\cancel{\refutable{\cor{\hxi_1}{\hxi_2}}}$ \BY{\autoref{lem:satisfy-not-refutable} on \pfref{[or2]notintro} and \pfref{[or2]satisfy-or}} \pflabel{[or2]notrft}
            \end{pfsteps*}
            \pfref{[or2]rft} and \pfref{[or2]notrft} are in contradiction with each other.
        \restorelocalsteps{2}
        \item[\text{(\ref{rule:CMSOr1})}]
            \begin{pfsteps*}
            \item $\cmaysatisfy{e}{\hxi_1}$ \BY{assumption}
    ...
    \item[\csatisfy{e}{\hxi_1},\cnotsatisfyormay{e}{\hxi_2}]
        ...
        \item[\text{(\ref{rule:CMSNotIntro})}]
          \begin{pfsteps*}
          \item $\notIntro{e}$ \BY{assumption} \pflabel{[or3]notintro}
          \item $\refutable{\cor{\hxi_1}{\hxi_2}}$ \BY{assumption} \pflabel{[or3]rft}
          \item $\cancel{\refutable{\cor{\hxi_1}{\hxi_2}}}$ \BY{\autoref{lem:satisfy-not-refutable} on \pfref{[or3]notintro} and \pfref{[or3]satisfy-or}} \pflabel{[or3]notrft}
          \end{pfsteps*}
          \pfref{[or3]rft} and \pfref{[or3]notrft} are in contradiction with each other.
        \restorelocalsteps{2}
        \item[\text{(\ref{rule:CMSOr1})}]
            \begin{pfsteps*}
            \item $\cmaysatisfy{e}{\hxi_1}$ \BY{assumption}
    ...
    \item[\cmaysatisfy{e}{\hxi_1},\csatisfy{e}{\hxi_2}]
        ...
        \item[\text{(\ref{rule:CMSNotIntro})}]
            \begin{pfsteps*}
            \item $\notIntro{e}$ \BY{assumption} \pflabel{[or4]notintro}
            \item $\refutable{\cor{\hxi_1}{\hxi_2}}$ \BY{assumption} \pflabel{[or4]rft}
            \item $\cancel{\refutable{\cor{\hxi_1}{\hxi_2}}}$ \BY{\autoref{lem:satisfy-not-refutable} on \pfref{[or4]notintro} and \pfref{[or4]satisfy-or}} \pflabel{[or4]notrft}
            \end{pfsteps*}
            \pfref{[or4]rft} and \pfref{[or4]notrft} are in contradiction with each other.
        \restorelocalsteps{2}
        \item[\text{(\ref{rule:CMSOr1})}]
            \begin{pfsteps*}
    ...
    \item[\cnotsatisfyormay{e}{\hxi_1},\csatisfy{e}{\hxi_2}]
        ...
        \item[\text{(\ref{rule:CMSNotIntro})}]
            \begin{pfsteps*}
            \item $\notIntro{e}$ \BY{assumption} \pflabel{[or7]notintro}
            \item $\refutable{\cor{\hxi_1}{\hxi_2}}$ \BY{assumption} \pflabel{[or7]rft}
            \item $\cancel{\refutable{\cor{\hxi_1}{\hxi_2}}}$ \BY{\autoref{lem:satisfy-not-refutable} on \pfref{[or7]notintro} and \pfref{[or7]satisfy-or}} \pflabel{[or7]notrft}
            \end{pfsteps*}
            \pfref{[or7]rft} and \pfref{[or7]notrft} are in contradiction with each other.
        \restorelocalsteps{2}
        \item[\text{(\ref{rule:CMSOr1})}]
            \begin{pfsteps*}
            \item $\cnotsatisfy{e}{\hxi_2}$ \BY{assumption}
    ...
    \item[\cnotsatisfyormay{e}{\hxi_1},\cnotsatisfyormay{e}{\hxi_2}]
        ...
        \item[\text{(\ref{rule:CMSNotIntro})}]
            \begin{pfsteps*}
            \item $\notIntro{e}$ \BY{assumption} \pflabel{[or9]notintro}
            \item $\refutable{\cor{\hxi_1}{\hxi_2}}$ \BY{assumption} \pflabel{[or9]rft}
            \end{pfsteps*}
            By rule induction over \rulesref{rules:xi-refutable} on \pfref{[or9]rft}, only one rule applies.
            \begin{byCases}
              \item[\text{(\ref{rule:RXOr})}]
              \begin{pfsteps}
              \item \refutable{\hxi_1} \BY{assumption} \pflabel{[or9]rft1}
              \item \cmaysatisfy{e}{\hxi_1} \BY{\ruleref{rule:CMSNotIntro} on \pfref{[or9]notintro} and \pfref{[or9]rft1}}
              \end{pfsteps} 
...
\item[\text{(\ref{rule:CTInl})}]
    ...
    \item[\text{(\ref{rule:TEHole}),(\ref{rule:THole}),(\ref{rule:TAp}),(\ref{rule:TFst}),(\ref{rule:TSnd}),(\ref{rule:TMatchZPre}),(\ref{rule:TMatchNZPre})}]
        ...
        \item $\refutable{\cinl{\hxi_1}}$ \BY{\ruleref{rule:RXInl}} \pflabel{[inl]rft-true}
...
\item[\text{(\ref{rule:CTInr})}]
    ...
    \item[\text{(\ref{rule:TEHole}),(\ref{rule:THole}),(\ref{rule:TAp}),(\ref{rule:TFst}),(\ref{rule:TSnd}),(\ref{rule:TMatchZPre}),(\ref{rule:TMatchNZPre})}]
        ...
        \item $\refutable{\cinr{\hxi_2}}$ \BY{\ruleref{rule:RXInr}} \pflabel{[inr]rft-true}
...
\begin{pfsteps*}
    ...
    \item[\text{(\ref{rule:TEHole}),(\ref{rule:THole}),(\ref{rule:TAp}),(\ref{rule:TFst}),(\ref{rule:TSnd}),(\ref{rule:TMatchZPre}),(\ref{rule:TMatchNZPre})}]
        \begin{pfsteps*}
        \item $e=\hehole{u},\hhole{e_0}{u},\hap{e_1}{e_2},\hfst{e_0},\hsnd{e_0},\hmatch{e_0}{\zrules}$ \BY{assumption}
        \item $\notIntro{e}$ \BY{Rule (\ref{rule:NVEHole}),(\ref{rule:NVHole}),(\ref{rule:NVAp}),(\ref{rule:NVMatch}),(\ref{rule:NVFst}),(\ref{rule:NVSnd})} \pflabel{[pair]notintro}
        \item $\isIndet{e}$ \BY{\autoref{lem:final-notintro-indet} on \pfref{eFinal} and \pfref{[pair]notintro}} \pflabel{[pair]indet}
        \item $\isIndet{\hfst{e}}$ \BY{Rule (\ref{rule:IFst}) on \pfref{[pair]indet}} \pflabel{[pair]fst-indet}
        \item $\isFinal{\hfst{e}}$ \BY{Rule (\ref{rule:FIndet}) on \pfref{[pair]fst-indet}} \pflabel{[pair]fst-final}
        \item $\isIndet{\hsnd{e}}$ \BY{Rule (\ref{rule:ISnd}) on \pfref{[pair]indet}} \pflabel{[pair]snd-indet}
        \item $\isFinal{\hsnd{e}}$ \BY{Rule (\ref{rule:FIndet}) on \pfref{[pair]snd-indet}} \pflabel{[pair]snd-final}
        \item $\notIntro{\hfst{e}}$ \BY{\ruleref{rule:NVFst}} \pflabel{[pair]fst-notintro}
        \item $\notIntro{\hsnd{e}}$ \BY{\ruleref{rule:NVSnd}} \pflabel{[pair]snd-notintro}
        \item $\hexptyp{\cdot}{\Delta}{\hfst{e}}{\tau_1}$ \BY{Rule (\ref{rule:TFst}) on \pfref{eTyp}} \pflabel{[pair]fst-typ}
        \item $\hexptyp{\cdot}{\Delta}{\hsnd{e}}{\tau_2}$ \BY{Rule (\ref{rule:TSnd}) on \pfref{eTyp}} \pflabel{[pair]snd-typ}
        \end{pfsteps*}
        By inductive hypothesis on \pfref{[pair]c1Typ} and \pfref{[pair]fst-typ} and \pfref{[pair]fst-final}, exactly one of $\csatisfy{\hfst{e}}{\hxi_1}$, $\cmaysatisfy{\hfst{e}}{\hxi_1}$, and $\cnotsatisfyormay{\hfst{e}}{\hxi_1}$ holds. \\
        By inductive hypothesis on \pfref{[pair]c2Typ} and \pfref{[pair]snd-typ} and \pfref{[pair]snd-final}, exactly one of $\csatisfy{\hsnd{e}}{\hxi_2}$, $\cmaysatisfy{\hsnd{e}}{\hxi_2}$, and $\cnotsatisfyormay{\hsnd{e}}{\hxi_2}$ holds. \\
        By case analysis on which conclusion holds for $\hxi_1$ and $\hxi_2$.
        \begin{byCases}
        \savelocalsteps{1}
        \item[\csatisfy{\hfst{e}}{\hxi_1},\csatisfy{\hsnd{e}}{\hxi_2}]
            \begin{pfsteps*}
            \item $\csatisfy{\hfst{e}}{\hxi_1}$ \BY{assumption} \pflabel{[pair1]satisfy1}
            \item $\cnotmaysatisfy{\hfst{e}}{\hxi_1}$ \BY{assumption} \pflabel{[pair1]notmaysat1}
            \item $\csatisfy{\hsnd{e}}{\hxi_2}$ \BY{assumption} \pflabel{[pair1]satisfy2}
            \item $\cnotmaysatisfy{\hsnd{e}}{\hxi_2}$ \BY{assumption} \pflabel{[pair1]notmaysat2}
        ...
        \restorelocalsteps{1}
        \item[\csatisfy{\hfst{e}}{\hxi_1},\cmaysatisfy{\hsnd{e}}{\hxi_2}]
            \begin{pfsteps*}
            \item $\csatisfy{\hfst{e}}{\hxi_1}$ \BY{assumption} \pflabel{[pair2]satisfy1}
            \item $\cnotmaysatisfy{\hfst{e}}{\hxi_1}$ \BY{assumption} \pflabel{[pair2]notmaysat1}
            \item $\cnotsatisfy{\hsnd{e}}{\hxi_2}$ \BY{assumption} \pflabel{[pair2]notsatisfy2}
            \item $\cmaysatisfy{\hsnd{e}}{\hxi_2}$ \BY{assumption} \pflabel{[pair2]maysat2}
            \item $\refutable{\hxi_2}$ \BY{\autoref{lem:notintro-maysat-or-notsat-refutable} on \pfref{[pair]snd-notintro} and \pfref{[pair2]maysat2}} \pflabel{[pair2]rft2}
            ...
            \item[\text{(\ref{rule:CSNotIntroPair})}]
                \begin{pfsteps*}
                \item $\csatisfy{\hsnd{e}}{\hxi_2}$ \BY{assumption}
                \end{pfsteps*}
        ...
        \item[\csatisfy{\hfst{e}}{\hxi_1},\cnotsatisfyormay{\hsnd{e}}{\hxi_2}]
            \begin{pfsteps*}
            \item $\csatisfy{\hfst{e}}{\hxi_1}$ \BY{assumption} \pflabel{[pair3]satisfy1}
            \item $\cnotmaysatisfy{\hfst{e}}{\hxi_1}$ \BY{assumption} \pflabel{[pair3]notmaysat1}
            \item $\cnotsatisfy{\hsnd{e}}{\hxi_2}$ \BY{assumption} \pflabel{[pair3]notsatisfy2}
            \item $\cnotmaysatisfy{\hsnd{e}}{\hxi_2}$ \BY{assumption} \pflabel{[pair3]notmaysat2}
            \end{pfsteps*}
            ...
            \item[\text{(\ref{rule:CMSNotIntro})}]
                ...
                \item[\text{(\ref{rule:RXPairL})}]
                    ...
                    \item $\notIntro{\hfst{e}}$ \BY{\ruleref{rule:NVFst}} \pflabel{[pair3]fst-notintro}
                    \item $\cmaysatisfy{\hfst{e}}{\hxi_1}$ \BY{\ruleref{rule:CMSNotIntro} on \pfref{[pair3]fst-notintro} and \pfref{[pair3]rft1}}
                    \end{pfsteps*}
                ...
                \item[\text{(\ref{rule:RXPairR})}]
                    ...
                    \item $\notIntro{\hsnd{e}}$ \BY{\ruleref{rule:NVSnd}} \pflabel{[pair3]snd-notintro}
                    \item $\cmaysatisfy{\hsnd{e}}{\hxi_2}$ \BY{\ruleref{rule:CMSNotIntro} on \pfref{[pair3]snd-notintro} and \pfref{[pair3]rft2}}
                    \end{pfsteps*}
        ...
        \restorelocalsteps{1}
        \item[\cmaysatisfy{\hfst{e}}{\hxi_1},\csatisfy{\hsnd{e}}{\hxi_2}]
            \begin{pfsteps*}
            \item $\cnotsatisfy{\hfst{e}}{\hxi_1}$ \BY{assumption} \pflabel{[pair4]notsatisfy1}
            \item $\cmaysatisfy{\hfst{e}}{\hxi_1}$ \BY{assumption} \pflabel{[pair4]maysat1}
            \item $\csatisfy{\hsnd{e}}{\hxi_2}$ \BY{assumption} \pflabel{[pair4]satisfy2}
            \item $\cnotmaysatisfy{\hsnd{e}}{\hxi_2}$ \BY{assumption} \pflabel{[pair4]notmaysat2}
            \item $\refutable{\hxi_1}$ \BY{\autoref{lem:notintro-maysat-or-notsat-refutable} on \pfref{[pair]fst-notintro} and \pfref{[pair4]maysat1}} \pflabel{[pair4]rft1}
            ...
            \item[\text{(\ref{rule:CSNotIntroPair})}]
                \begin{pfsteps*}
                \item $\csatisfy{\hfst{e}}{\hxi_1}$ \BY{assumption}
                \end{pfsteps*}
        ...
        \restorelocalsteps{1}
        \item[\cmaysatisfy{\hfst{e}}{\hxi_1},\cmaysatisfy{\hsnd{e}}{\hxi_2}]
            \begin{pfsteps*}
            \item $\cnotsatisfy{\hfst{e}}{\hxi_1}$ \BY{assumption} \pflabel{[pair5]notsatisfy1}
            \item $\cmaysatisfy{\hfst{e}}{\hxi_1}$ \BY{assumption} \pflabel{[pair5]maysat1}
            \item $\cnotsatisfy{\hsnd{e}}{\hxi_2}$ \BY{assumption} \pflabel{[pair5]notsatisfy2}
            \item $\cmaysatisfy{\hsnd{e}}{\hxi_2}$ \BY{assumption} \pflabel{[pair5]maysat2}
            \item $\refutable{\hxi_2}$ \BY{\autoref{lem:notintro-maysat-or-notsat-refutable} on \pfref{[pair]fst-notintro} and \pfref{[pair5]maysat1}} \pflabel{[pair5]rft2}
        ...
        \restorelocalsteps{1}
        \item[\cmaysatisfy{\hfst{e}}{\hxi_1},\cnotsatisfyormay{\hsnd{e}}{\hxi_2}]
            \begin{pfsteps*}
            \item $\cnotsatisfy{\hfst{e}}{\hxi_1}$ \BY{assumption} \pflabel{[pair6]notsatisfy1}
            \item $\cmaysatisfy{\hfst{e}}{\hxi_1}$ \BY{assumption} \pflabel{[pair6]maysat1}
            \item $\cnotsatisfy{\hsnd{e}}{\hxi_2}$ \BY{assumption} \pflabel{[pair6]notsatisfy2}
            \item $\cnotmaysatisfy{\hsnd{e}}{\hxi_2}$ \BY{assumption} \pflabel{[pair6]notmaysat2}
            \item $\refutable{\hxi_1}$ \BY{\autoref{lem:notintro-maysat-or-notsat-refutable} on \pfref{[pair]fst-notintro} and \pfref{[pair6]maysat1}} \pflabel{[pair6]rft1}
        ...
        \item[\cnotsatisfyormay{\hfst{e}}{\hxi_1},\csatisfy{\hsnd{e}}{\hxi_2}]
            \begin{pfsteps*}
            \item $\cnotsatisfy{\hfst{e}}{\hxi_1}$ \BY{assumption} \pflabel{[pair7]notsatisfy1}
            \item $\cnotmaysatisfy{\hfst{e}}{\hxi_1}$ \BY{assumption} \pflabel{[pair7]notmaysat1}
            \item $\csatisfy{\hsnd{e}}{\hxi_2}$ \BY{assumption} \pflabel{[pair7]satisfy2}
            \item $\cnotmaysatisfy{\hsnd{e}}{\hxi_2}$ \BY{assumption} \pflabel{[pair7]notmaysat2}
            \end{pfsteps*}
            Assume $\csatisfy{e}{\cpair{\hxi_1}{\hxi_2}}$. By rule induction over Rules (\ref{rules:Satisfy}) on it, only one case applies.
            \begin{byCases}
            \item[\text{(\ref{rule:CSNotIntroPair})}]
            ...
            \item[\text{(\ref{rule:CMSNotIntro})}]
                ...
                \item[\text{(\ref{rule:RXPairL})}]
                    ...
                    \item $\notIntro{\hfst{e}}$ \BY{\ruleref{rule:NVFst}} \pflabel{[pair7]fst-notintro}
                    \item $\cmaysatisfy{\hfst{e}}{\hxi_1}$ \BY{\ruleref{rule:CMSNotIntro} on \pfref{[pair7]fst-notintro} and \pfref{[pair7]rft1}}
                    \end{pfsteps*}
                    Contradicts \pfref{[pair3]notmaysat1}.
                \restorelocalsteps{2}
                \item[\text{(\ref{rule:RXPairR})}]
                    ...
                    \item $\notIntro{\hsnd{e}}$ \BY{\ruleref{rule:NVSnd}} \pflabel{[pair7]snd-notintro}
                    \item $\cmaysatisfy{\hsnd{e}}{\hxi_2}$ \BY{\ruleref{rule:CMSNotIntro} on \pfref{[pair7]snd-notintro} and \pfref{[pair7]rft2}}
                    \end{pfsteps*}
        ...
        \restorelocalsteps{1}
        \item[\cnotsatisfyormay{\hfst{e}}{\hxi_1},\cmaysatisfy{\hsnd{e}}{\hxi_2}]
            \begin{pfsteps*}
            \item $\cnotsatisfy{\hfst{e}}{\hxi_1}$ \BY{assumption} \pflabel{[pair8]notsatisfy1}
            \item $\cnotmaysatisfy{\hfst{e}}{\hxi_1}$ \BY{assumption} \pflabel{[pair8]notmaysat1}
            \item $\cnotsatisfy{\hsnd{e}}{\hxi_2}$ \BY{assumption} \pflabel{[pair8]notsatisfy2}
            \item $\cmaysatisfy{\hsnd{e}}{\hxi_2}$ \BY{assumption} \pflabel{[pair8]maysat2}
            \item $\refutable{\hxi_2}$ \BY{\autoref{lem:notintro-maysat-or-notsat-refutable} on \pfref{[pair]snd-notintro} and \pfref{[pair8]maysat2}} \pflabel{[pair8]rft2}
        ...
        \item[\cnotsatisfyormay{\hfst{e}}{\hxi_1},\cnotsatisfyormay{\hsnd{e}}{\hxi_2}]
            \begin{pfsteps*}
            \item $\cnotsatisfy{\hfst{e}}{\hxi_1}$ \BY{assumption} \pflabel{[pair9]notsatisfy1}
            \item $\cnotmaysatisfy{\hfst{e}}{\hxi_1}$ \BY{assumption} \pflabel{[pair9]notmaysat1}
            \item $\cnotsatisfy{\hsnd{e}}{\hxi_2}$ \BY{assumption} \pflabel{[pair9]notsatisfy2}
            \item $\cnotmaysatisfy{\hsnd{e}}{\hxi_2}$ \BY{assumption} \pflabel{[pair9]notmaysat2}
            \end{pfsteps*}
            Assume $\csatisfy{e}{\cpair{\hxi_1}{\hxi_2}}$. By rule induction over Rules (\ref{rules:Satisfy}) on it, only one case applies.
            \begin{byCases}
            \item[\text{(\ref{rule:CSNotIntroPair})}]
            ...
            \item[\text{(\ref{rule:CMSNotIntro})}]
                ...
                \item[\text{(\ref{rule:RXPairL})}]
                    ...
                    \item $\notIntro{\hfst{e}}$ \BY{\ruleref{rule:NVFst}} \pflabel{[pair9]fst-notintro}
                    \item $\cmaysatisfy{\hfst{e}}{\hxi_1}$ \BY{\ruleref{rule:CMSNotIntro} on \pfref{[pair9]fst-notintro} and \pfref{[pair9]rft1}}
                    \end{pfsteps*}
                ...
                \item[\text{(\ref{rule:RXPairR})}]
                    ...
                    \item $\notIntro{\hsnd{e}}$ \BY{\ruleref{rule:NVSnd}} \pflabel{[pair9]snd-notintro}
                    \item $\cmaysatisfy{\hsnd{e}}{\hxi_2}$ \BY{\ruleref{rule:CMSNotIntro} on \pfref{[pair9]snd-notintro} and \pfref{[pair9]rft2}}
                    \end{pfsteps*}

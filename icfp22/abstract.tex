\begin{abstract}
    ...
    By assigning static and, to varying degree, dynamic meaning to programs with holes, editors and other tools can offer more meaningful  feedback and suggestions throughout the editing process, i.e. \emph{live}.
    ...
    Finally, we scale up the core calculus to support finite labeled sums and integrate the mechanism into Hazel, a live functional 
